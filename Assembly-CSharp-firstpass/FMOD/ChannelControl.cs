...
namespace FMOD
{
	public class ChannelControl : HandleBase
	{
		...
		public RESULT getSystemObject(out FMOD.System system)
		{
			system = null;
			IntPtr intPtr;
			RESULT result = ChannelControl.FMOD5_ChannelGroup_GetSystemObject(this.rawPtr, out intPtr);
		...
		public RESULT getDSP(int index, out DSP dsp)
		{
			dsp = null;
			IntPtr intPtr;
			RESULT result = ChannelControl.FMOD5_ChannelGroup_GetDSP(this.rawPtr, index, out intPtr);
			dsp = new DSP(intPtr);
			return result;
		}
