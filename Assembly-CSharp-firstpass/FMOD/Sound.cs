...
namespace FMOD
{
	public class Sound : HandleBase
	{
		...
		public RESULT getSystemObject(out FMOD.System system)
		{
			system = null;
			IntPtr intPtr;
			RESULT result = Sound.FMOD5_Sound_GetSystemObject(this.rawPtr, out intPtr);
		...
		public RESULT getSubSound(int index, out Sound subsound)
		{
			subsound = null;
			IntPtr intPtr;
			RESULT result = Sound.FMOD5_Sound_GetSubSound(this.rawPtr, index, out intPtr);
			subsound = new Sound(intPtr);
			return result;
		}
		...
		public RESULT getSubSoundParent(out Sound parentsound)
		{
			parentsound = null;
			IntPtr intPtr;
			RESULT result = Sound.FMOD5_Sound_GetSubSoundParent(this.rawPtr, out intPtr);
			parentsound = new Sound(intPtr);
			return result;
		}
		...
		public RESULT getSoundGroup(out SoundGroup soundgroup)
		{
			soundgroup = null;
			IntPtr intPtr;
			RESULT result = Sound.FMOD5_Sound_GetSoundGroup(this.rawPtr, out intPtr);
