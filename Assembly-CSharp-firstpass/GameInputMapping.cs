...
public class GameInputMapping
{
	...
	public static readonly BindingEntry[] DefaultBindings = new BindingEntry[]
	{
		...
		new BindingEntry("Root", GamepadButton.NumButtons, KKeyCode.V, Modifier.None, global::Action.ManageVitals, true),
		new BindingEntry("Root", GamepadButton.NumButtons, KKeyCode.R, Modifier.None, global::Action.ManageResearch, true),
		new BindingEntry("Root", GamepadButton.NumButtons, KKeyCode.E, Modifier.None, global::Action.ManageReport, true),
		...
		new BindingEntry("Root", GamepadButton.NumButtons, KKeyCode.Mouse0, Modifier.None, global::Action.MouseLeft, true),
		new BindingEntry("Root", GamepadButton.NumButtons, KKeyCode.Mouse1, Modifier.None, global::Action.MouseRight, true),
		new BindingEntry("Root", GamepadButton.NumButtons, KKeyCode.Mouse2, Modifier.None, global::Action.MouseMiddle, true),
		...
		new BindingEntry("Building", GamepadButton.NumButtons, KKeyCode.Backslash, Modifier.None, global::Action.Empty, true),
		new BindingEntry("Building", GamepadButton.NumButtons, KKeyCode.Backslash, Modifier.None, global::Action.DropAll, true),
		new BindingEntry("Building", GamepadButton.NumButtons, KKeyCode.Return, Modifier.None, global::Action.ToggleEnabled, true),
		new BindingEntry("Building", GamepadButton.NumButtons, KKeyCode.Equals, Modifier.None, global::Action.Increment, true),
		new BindingEntry("Building", GamepadButton.NumButtons, KKeyCode.Minus, Modifier.None, global::Action.Decrement, true),
		new BindingEntry("Building", GamepadButton.NumButtons, KKeyCode.Equals, Modifier.Shift, global::Action.IncrementAlt, true),
		new BindingEntry("Building", GamepadButton.NumButtons, KKeyCode.Minus, Modifier.Shift, global::Action.DecrementAlt, true),
		...
		new BindingEntry("Debug", GamepadButton.NumButtons, KKeyCode.F8, Modifier.Alt, global::Action.DebugApplyHighAudioReverb, true),
		new BindingEntry("Debug", GamepadButton.NumButtons, KKeyCode.F9, Modifier.Alt, global::Action.DebugApplyLowAudioReverb, true),
		new BindingEntry("Debug", GamepadButton.NumButtons, KKeyCode.F10, Modifier.Alt, global::Action.DebugForceLightEverywhere, true),
		new BindingEntry("Debug", GamepadButton.NumButtons, KKeyCode.F1, Modifier.Shift, global::Action.DebugVisualTest, true),
		...
		new BindingEntry("Debug", GamepadButton.NumButtons, KKeyCode.Alpha0, Modifier.None, global::Action.DebugPaintForceFlower, true),
		...
		new BindingEntry("Debug", GamepadButton.NumButtons, KKeyCode.F11, Modifier.Alt, global::Action.DebugCellInfo, true),
