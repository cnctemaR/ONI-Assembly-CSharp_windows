		...
		public float GetValue(float x, float y, float z)
		{
			...
			for (int i = num3 - 2; i <= num3 + 2; i++)
			{
				for (int j = num2 - 2; j <= num2 + 2; j++)
				{
					...
					{
						float num8 = (float)k + this._source3D.GetValue((float)k, (float)j, (float)i);
						float num9 = (float)j + this._source3D.GetValue((float)k, (float)j, (float)i);
						float num10 = (float)i + this._source3D.GetValue((float)k, (float)j, (float)i);
						float num11 = num8 - x;
						float num12 = num9 - y;
						float num13 = num10 - z;
			...
			if (this._distance)
			{
				...
				float num16 = num6 - y;
				float num17 = num7 - z;
				num18 = (float)Math.Sqrt((double)(num15 * num15 + num16 * num16 + num17 * num17)) * 1.7320508f - 1f;
			}
			else
			{
				num18 = 0f;
			}
			return num18 + this._displacement * this._source3D.GetValue((float)((int)Math.Floor((double)num5)), (float)((int)Math.Floor((double)num6)), (float)((int)Math.Floor((double)num7)));
		}
