...
namespace LibNoiseDotNet.Graphics.Tools.Noise.Primitive
{
	public class BevinsValue : PrimitiveModule, IModule3D, IModule, IModule2D, IModule1D
	{
		...
		public static float ValueCoherentNoise3D(float x, float y, float z, long seed, NoiseQuality quality)
		{
			...
			float num13 = BevinsValue.ValueNoise3D(num, num4, num5, seed);
			num11 = BevinsValue.ValueNoise3D(num2, num4, num5, seed);
			float num14 = Libnoise.Lerp(num13, num11, num7);
			float num15 = Libnoise.Lerp(num12, num14, num8);
			float num16 = BevinsValue.ValueNoise3D(num, num3, num6, seed);
			num11 = BevinsValue.ValueNoise3D(num2, num3, num6, seed);
			float num17 = Libnoise.Lerp(num16, num11, num7);
			float num18 = BevinsValue.ValueNoise3D(num, num4, num6, seed);
			num11 = BevinsValue.ValueNoise3D(num2, num4, num6, seed);
			num14 = Libnoise.Lerp(num18, num11, num7);
			float num19 = Libnoise.Lerp(num17, num14, num8);
			return Libnoise.Lerp(num15, num19, num9);
		}
		...
		public float ValueCoherentNoise2D(float x, float y, long seed, NoiseQuality quality)
		{
			...
			float num10 = this.ValueNoise2D(num, num4, seed);
			num8 = this.ValueNoise2D(num2, num4, seed);
			float num11 = Libnoise.Lerp(num10, num8, num5);
			return Libnoise.Lerp(num9, num11, num6);
		}
