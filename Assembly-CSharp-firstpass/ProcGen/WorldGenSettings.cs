...
namespace ProcGen
{
	public class WorldGenSettings
	{
		...
		public static WorldGenSettings LoadFile(string path)
		{
			...
			foreach (KeyValuePair<string, TerrainFeature> keyValuePair3 in worldGenSettings.features.TerrainFeatures)
			{
			...
			foreach (KeyValuePair<string, Room> keyValuePair4 in worldGenSettings.rooms.rooms)
			{
			...
			foreach (KeyValuePair<string, SubWorld> keyValuePair5 in worldGenSettings.subworlds.zones)
			{
			...
			foreach (KeyValuePair<string, Mob> keyValuePair6 in worldGenSettings.mobs.MobLookupTable)
			{
				keyValuePair6.Value.name = keyValuePair6.Key;
			}
