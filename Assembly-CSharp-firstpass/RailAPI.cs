...
public static class RailAPI
{
	...
	[DllImport("RailAPI")]
	public static extern void RegisterEventHandler(RailAPI.Event eventId, RailAPI.EventHandler handler);

	[DllImport("RailAPI")]
	public static extern void UnregisterEventHandler(RailAPI.Event eventId, RailAPI.EventHandler handler);
