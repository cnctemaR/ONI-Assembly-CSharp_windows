...
namespace Steamworks
{
	public static class SteamController
	{
		...
		public static ControllerActionSetHandle_t GetActionSetHandle(string pszActionSetName)
		{
			...
			{
				controllerActionSetHandle_t = (ControllerActionSetHandle_t)NativeMethods.ISteamController_GetActionSetHandle(CSteamAPIContext.GetSteamController(), utf8StringHandle);
			}
		...
		public static ControllerDigitalActionHandle_t GetDigitalActionHandle(string pszActionName)
		{
			...
			{
				controllerDigitalActionHandle_t = (ControllerDigitalActionHandle_t)NativeMethods.ISteamController_GetDigitalActionHandle(CSteamAPIContext.GetSteamController(), utf8StringHandle);
			}
		...
		public static ControllerAnalogActionHandle_t GetAnalogActionHandle(string pszActionName)
		{
			...
			using (InteropHelp.UTF8StringHandle utf8StringHandle = new InteropHelp.UTF8StringHandle(pszActionName))
			{
				controllerAnalogActionHandle_t = (ControllerAnalogActionHandle_t)NativeMethods.ISteamController_GetAnalogActionHandle(CSteamAPIContext.GetSteamController(), utf8StringHandle);
			}
