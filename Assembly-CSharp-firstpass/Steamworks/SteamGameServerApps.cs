...
namespace Steamworks
{
	public static class SteamGameServerApps
	{
		...
		public static string GetLaunchQueryParam(string pchKey)
		{
			...
			{
				text = InteropHelp.PtrToStringUTF8(NativeMethods.ISteamApps_GetLaunchQueryParam(CSteamGameServerAPIContext.GetSteamApps(), utf8StringHandle));
			}
			return text;
		}
		...
		public static SteamAPICall_t GetFileDetails(string pszFileName)
		{
			...
			{
				steamAPICall_t = (SteamAPICall_t)NativeMethods.ISteamApps_GetFileDetails(CSteamGameServerAPIContext.GetSteamApps(), utf8StringHandle);
			}
