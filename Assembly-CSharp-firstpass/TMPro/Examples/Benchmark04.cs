	...
	public class Benchmark04 : MonoBehaviour
	{
		private void Start()
		{
			...
			for (int i = this.MinPointSize; i <= this.MaxPointSize; i += this.Steps)
			{
				if (this.SpawnType == 0)
				{
					GameObject gameObject = new GameObject("Arial " + i);
					if (num > num3 * 2f)
					{
						return;
					}
					...
					TextContainer component = gameObject.GetComponent<TextContainer>();
					component.anchorPosition = TextContainerAnchors.Left;
