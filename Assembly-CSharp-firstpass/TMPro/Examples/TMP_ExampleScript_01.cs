...
namespace TMPro.Examples
{
	public class TMP_ExampleScript_01 : MonoBehaviour
	{
		private void Awake()
		{
			...
			this.m_text.font = Resources.Load<TMP_FontAsset>("Fonts & Materials/IMPACT SDF");
			this.m_text.fontSharedMaterial = Resources.Load<Material>("Fonts & Materials/IMPACT SDF - Drop Shadow");
