	...
	public class TextMeshProFloatingText : MonoBehaviour
	{
		...
		private void Start()
		{
			if (this.SpawnType == 0)
			{
				...
				this.m_textContainer = this.m_floatingText.GetComponent<TextContainer>();
				...
				this.m_textContainer.isAutoFitting = false;
		...
		public IEnumerator DisplayTextMeshProFloatingText()
		{
			...
			while (current_Count > 0f)
			{
				...
				if (!this.lastPOS.Compare(this.m_cameraTransform.position, 1000) || !this.lastRotation.Compare(this.m_cameraTransform.rotation, 1000))
				{
					...
					this.m_transform.forward = new Vector3(dir.x, 0f, dir.z);
				}
