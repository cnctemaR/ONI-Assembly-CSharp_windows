		...
		protected override void GenerateTextMesh()
		{
			...
			else
			{
				...
				case TextAlignmentOptions.TopJustified:
					...
					{
						vector7 = rectTransformCorners[1] + new Vector3(0f + margin.x, 0f - this.m_maxAscender - margin.y, 0f);
					}
					else
					{
						vector7 = rectTransformCorners[1] + new Vector3(0f + margin.x, 0f - this.m_textInfo.pageInfo[num6].ascender - margin.y, 0f);
					}
					break;
				...
				case TextAlignmentOptions.Justified:
					if (this.m_overflowMode != TextOverflowModes.Page)
					{
						vector7 = (rectTransformCorners[0] + rectTransformCorners[1]) / 2f + new Vector3(0f + margin.x, 0f - (this.m_maxAscender + margin.y + num10 - margin.w) / 2f, 0f);
					}
					else
					{
						vector7 = (rectTransformCorners[0] + rectTransformCorners[1]) / 2f + new Vector3(0f + margin.x, 0f - (this.m_textInfo.pageInfo[num6].ascender + margin.y + this.m_textInfo.pageInfo[num6].descender - margin.w) / 2f, 0f);
					}
					break;
				...
				case TextAlignmentOptions.BottomJustified:
					if (this.m_overflowMode != TextOverflowModes.Page)
					{
						vector7 = rectTransformCorners[0] + new Vector3(0f + margin.x, 0f - num10 + margin.w, 0f);
					}
					else
					{
						vector7 = rectTransformCorners[0] + new Vector3(0f + margin.x, 0f - this.m_textInfo.pageInfo[num6].descender + margin.w, 0f);
					}
					break;
				...
				case TextAlignmentOptions.BaselineJustified:
					vector7 = (rectTransformCorners[0] + rectTransformCorners[1]) / 2f + new Vector3(0f + margin.x, 0f, 0f);
					break;
				case TextAlignmentOptions.MidlineLeft:
				case TextAlignmentOptions.Midline:
				case TextAlignmentOptions.MidlineRight:
				case TextAlignmentOptions.MidlineJustified:
					vector7 = (rectTransformCorners[0] + rectTransformCorners[1]) / 2f + new Vector3(0f + margin.x, 0f - (this.m_meshExtents.max.y + margin.y + this.m_meshExtents.min.y - margin.w) / 2f, 0f);
					break;
				}
				...
				for (int i = 0; i < this.m_characterCount; i++)
				{
					...
					if (isVisible)
					{
						...
						else
						{
							...
							float num57 = characterInfo[i].scale * (1f - this.m_charWidthAdjDelta);
							...
							case RenderMode.ScreenSpaceOverlay:
								num57 *= num43 / scaleFactor;
								break;
							case RenderMode.ScreenSpaceCamera:
								num57 *= ((!flag8) ? 1f : num43);
								break;
