...
public class BasicFabricMaterialPlantConfig : IEntityConfig
{
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToBasicPlant(gameObject2, num2, num3, num4, num5, new SimHashes[]
		{
			...
			SimHashes.Water
		}, false, 0f, 0.15f, id2, false, true, true, true, 2400f, 0f, 460f, BasicFabricMaterialPlantConfig.ID + "Original", global::STRINGS.CREATURES.SPECIES.BASICFABRICMATERIALPLANT.NAME);
