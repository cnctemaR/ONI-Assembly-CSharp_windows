...
public class ClusterTelescopeEnclosedConfig : IBuildingConfig
{
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		ManualCodexConversionRegistry.AddConversion(null, 0f, "ClusterTelescopeEnclosed", 0f, DatabankHelper.ID, 3f, global::STRINGS.BUILDINGS.PREFABS.CLUSTERTELESCOPEENCLOSED.NAME, null, null, (Tag tag, float amount, bool continuous) => string.Format(UI.BUILDINGEFFECTS.PER_STARMAP_HEX, GameUtil.GetFormattedInt((float)((int)amount), GameUtil.TimeSlice.None)));
	}
