...
public class ColdWheatBreadConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		gameObject = EntityTemplates.ExtendEntityToFood(gameObject, FOOD.FOOD_TYPES.COLD_WHEAT_BREAD, true);
		string text = ITEMS.FOOD.COLDWHEATBREAD.RECIPEDESC;
		Recipe recipe = new Recipe("ColdWheatBread", 1f, (SimHashes)0, null, text, 50).SetFabricator("CookingStation", FOOD.RECIPES.STANDARD_COOK_TIME);
