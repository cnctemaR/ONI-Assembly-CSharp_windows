...
public class CrabWoodConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.ExtendEntityToWildCreature(BaseCrabConfig.BaseCrab(id, name, desc, anim_file, "CrabWoodBaseTrait", is_baby, CrabWoodConfig.animPrefix, deathDropIDs, deathDropCounts), CrabTuning.PEN_SIZE_PER_CREATURE);
	...
	{
		GameObject gameObject = CrabWoodConfig.CreateCrabWood("CrabWood", global::STRINGS.CREATURES.SPECIES.CRAB.VARIANT_WOOD.NAME, global::STRINGS.CREATURES.SPECIES.CRAB.VARIANT_WOOD.DESC, "pincher_kanim", false, new string[] { "CrabWoodShell", "ShellfishMeat" }, new float[] { 500f, 1.2f });
