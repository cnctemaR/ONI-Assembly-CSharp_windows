...
namespace Database
{
	public class Amounts : ResourceSet<Amount>
	{
		...
		public Amount CreateAmount(string id, float min, float max, bool show_max, Units units, float delta_threshold, bool show_in_ui, string string_root, string uiSprite = null, string thoughtSprite = null)
		{
			...
			Klei.AI.Attribute attribute = new Klei.AI.Attribute(id + "Min", "Minimum" + text, "", "", min, Klei.AI.Attribute.Display.Normal, false, null, null);
			Klei.AI.Attribute attribute2 = new Klei.AI.Attribute(id + "Max", "Maximum" + text, "", "", max, Klei.AI.Attribute.Display.Normal, false, null, null);
			...
			Klei.AI.Attribute attribute3 = new Klei.AI.Attribute(text3, text4, "", text5, 0f, Klei.AI.Attribute.Display.Normal, false, null, null);
