...
namespace Database
{
	public class CritterAttributes : ResourceSet<Klei.AI.Attribute>
	{
		...
		{
			this.Happiness = base.Add(new Klei.AI.Attribute("Happiness", false, Klei.AI.Attribute.Display.General, false, 0f));
			this.Metabolism = base.Add(new Klei.AI.Attribute("Metabolism", false, Klei.AI.Attribute.Display.Details, false, 0f));
