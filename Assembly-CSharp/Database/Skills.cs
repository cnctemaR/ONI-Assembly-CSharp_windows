...
namespace Database
{
	public class Skills : ResourceSet<Skill>
	{
			...
			: base("Skills", parent)
		{
			...
			}, new List<string> { this.Mining1.Id }, "Minion"));
			...
			}, new List<string> { this.Mining2.Id }, "Minion"));
			this.Mining4 = this.AddSkill(new Skill("Mining4", DUPLICANTS.ROLES.MASTER_MINER.NAME, DUPLICANTS.ROLES.MASTER_MINER.DESCRIPTION, "EXPANSION1_ID", 3, "hat_role_mining4", "skillbadge_role_mining4", Db.Get().SkillGroups.Mining.Id, new List<SkillPerk> { Db.Get().SkillPerks.CanDigRadioactiveMaterials }, new List<string> { this.Mining3.Id }, "Minion"));
			this.Building1 = this.AddSkill(new Skill("Building1", DUPLICANTS.ROLES.JUNIOR_BUILDER.NAME, DUPLICANTS.ROLES.JUNIOR_BUILDER.DESCRIPTION, "", 0, "hat_role_building1", "skillbadge_role_building1", Db.Get().SkillGroups.Building.Id, new List<SkillPerk> { Db.Get().SkillPerks.IncreaseConstructionSmall }, null, "Minion"));
			this.Building2 = this.AddSkill(new Skill("Building2", DUPLICANTS.ROLES.BUILDER.NAME, DUPLICANTS.ROLES.BUILDER.DESCRIPTION, "", 1, "hat_role_building2", "skillbadge_role_building2", Db.Get().SkillGroups.Building.Id, new List<SkillPerk> { Db.Get().SkillPerks.IncreaseConstructionMedium }, new List<string> { this.Building1.Id }, "Minion"));
			...
			}, new List<string> { this.Building2.Id }, "Minion"));
			this.Farming1 = this.AddSkill(new Skill("Farming1", DUPLICANTS.ROLES.JUNIOR_FARMER.NAME, DUPLICANTS.ROLES.JUNIOR_FARMER.DESCRIPTION, "", 0, "hat_role_farming1", "skillbadge_role_farming1", Db.Get().SkillGroups.Farming.Id, new List<SkillPerk> { Db.Get().SkillPerks.IncreaseBotanySmall }, null, "Minion"));
			...
			}, new List<string> { this.Farming1.Id }, "Minion"));
			this.Farming3 = this.AddSkill(new Skill("Farming3", DUPLICANTS.ROLES.SENIOR_FARMER.NAME, DUPLICANTS.ROLES.SENIOR_FARMER.DESCRIPTION, "", 2, "hat_role_farming3", "skillbadge_role_farming3", Db.Get().SkillGroups.Farming.Id, new List<SkillPerk> { Db.Get().SkillPerks.IncreaseBotanyLarge }, new List<string> { this.Farming2.Id }, "Minion"));
			...
			}, new List<string> { this.Ranching1.Id }, "Minion"));
			...
			}, new List<string> { this.Researching1.Id }, "Minion"));
			...
			}, new List<string> { this.Researching2.Id }, "Minion"));
			...
			}, new List<string> { this.Astronomy.Id }, "Minion"));
			if (DlcManager.IsExpansion1Active())
			{
				this.RocketPiloting1 = this.AddSkill(new Skill("RocketPiloting1", DUPLICANTS.ROLES.ROCKETPILOT.NAME, DUPLICANTS.ROLES.ROCKETPILOT.DESCRIPTION, "EXPANSION1_ID", 0, "hat_role_astronaut1", "skillbadge_role_rocketry1", Db.Get().SkillGroups.Rocketry.Id, new List<SkillPerk> { Db.Get().SkillPerks.CanUseRocketControlStation }, new List<string>(), "Minion"));
			...
			}, new List<string> { this.Cooking1.Id }, "Minion"));
			...
			}, new List<string> { this.Arting1.Id }, "Minion"));
			...
			}, new List<string> { this.Arting2.Id }, "Minion"));
			...
			}, new List<string> { this.Hauling1.Id }, "Minion"));
			if (DlcManager.IsExpansion1Active())
			{
			...
			}, new List<string> { this.ThermalSuits.Id }, "Minion"));
			this.Technicals1 = this.AddSkill(new Skill("Technicals1", DUPLICANTS.ROLES.MACHINE_TECHNICIAN.NAME, DUPLICANTS.ROLES.MACHINE_TECHNICIAN.DESCRIPTION, "", 0, "hat_role_technicals1", "skillbadge_role_technicals1", Db.Get().SkillGroups.Technicals.Id, new List<SkillPerk> { Db.Get().SkillPerks.IncreaseMachinerySmall }, null, "Minion"));
			...
			}, new List<string> { this.Technicals1.Id }, "Minion"));
			...
			this.Basekeeping1 = this.AddSkill(new Skill("Basekeeping1", DUPLICANTS.ROLES.HANDYMAN.NAME, DUPLICANTS.ROLES.HANDYMAN.DESCRIPTION, "", 0, "hat_role_basekeeping1", "skillbadge_role_basekeeping1", Db.Get().SkillGroups.Basekeeping.Id, new List<SkillPerk> { Db.Get().SkillPerks.IncreaseStrengthGroundskeeper }, null, "Minion"));
			...
			if (DlcManager.IsExpansion1Active())
			{
				...
				this.Astronauting2 = this.AddSkill(new Skill("Astronauting2", DUPLICANTS.ROLES.USELESSSKILL.NAME, DUPLICANTS.ROLES.USELESSSKILL.DESCRIPTION, "EXPANSION1_ID", 4, "hat_role_astronaut2", "skillbadge_role_astronaut2", Db.Get().SkillGroups.Suits.Id, new List<SkillPerk> { Db.Get().SkillPerks.IncreaseAthleticsMedium }, new List<string> { this.Astronauting1.Id }, "Minion"));
			...
			else
			{
				...
				this.Astronauting2 = this.AddSkill(new Skill("Astronauting2", DUPLICANTS.ROLES.ASTRONAUT.NAME, DUPLICANTS.ROLES.ASTRONAUT.DESCRIPTION, "", 4, "hat_role_astronaut2", "skillbadge_role_astronaut2", Db.Get().SkillGroups.Suits.Id, new List<SkillPerk> { Db.Get().SkillPerks.FasterSpaceFlight }, new List<string> { this.Astronauting1.Id }, "Minion"));
			}
			...
			}, new List<string> { this.Medicine1.Id }, "Minion"));
			...
			}, new List<string> { this.Medicine2.Id }, "Minion"));
			if (DlcManager.IsContentSubscribed("DLC3_ID"))
			{
				this.BionicsA1 = this.AddSkill(new Skill("BionicsA1", DUPLICANTS.ROLES.BIONICS_A1.NAME, DUPLICANTS.ROLES.BIONICS_A1.DESCRIPTION, "DLC3_ID", 0, "hat_role_gainingboosters1", "skillbadge_bionic_booster1", Db.Get().SkillGroups.BionicSkills.Id, new List<SkillPerk> { Db.Get().SkillPerks.ExtraBionicBooster1 }, new List<string>(), GameTags.Minions.Models.Bionic.Name));
				this.BionicsA2 = this.AddSkill(new Skill("BionicsA2", DUPLICANTS.ROLES.BIONICS_A2.NAME, DUPLICANTS.ROLES.BIONICS_A2.DESCRIPTION, "DLC3_ID", 1, "hat_role_gainingboosters2", "skillbadge_bionic_booster2", Db.Get().SkillGroups.BionicSkills.Id, new List<SkillPerk>
				{
					Db.Get().SkillPerks.ExtraBionicBooster2,
					Db.Get().SkillPerks.IncreaseAthleticsBionicsA2
				}, new List<string> { this.BionicsA1.Id }, GameTags.Minions.Models.Bionic.Name));
				this.BionicsA3 = this.AddSkill(new Skill("BionicsA3", DUPLICANTS.ROLES.BIONICS_A3.NAME, DUPLICANTS.ROLES.BIONICS_A3.DESCRIPTION, "DLC3_ID", 2, "hat_role_gainingboosters3", "skillbadge_bionic_booster3", Db.Get().SkillGroups.BionicSkills.Id, new List<SkillPerk>
				{
					Db.Get().SkillPerks.ExtraBionicBooster3,
					Db.Get().SkillPerks.ExosuitExpertise
				}, new List<string> { this.BionicsA2.Id }, GameTags.Minions.Models.Bionic.Name));
				this.BionicsB1 = this.AddSkill(new Skill("BionicsB1", DUPLICANTS.ROLES.BIONICS_B1.NAME, DUPLICANTS.ROLES.BIONICS_B1.DESCRIPTION, "DLC3_ID", 0, "hat_role_innerworkings1", "skillbadge_bionic_gears1", Db.Get().SkillGroups.BionicSkills.Id, new List<SkillPerk> { Db.Get().SkillPerks.EfficientBionicGears }, new List<string>(), GameTags.Minions.Models.Bionic.Name));
				this.BionicsB2 = this.AddSkill(new Skill("BionicsB2", DUPLICANTS.ROLES.BIONICS_B2.NAME, DUPLICANTS.ROLES.BIONICS_B2.DESCRIPTION, "DLC3_ID", 1, "hat_role_innerworkings2", "skillbadge_bionic_gears2", Db.Get().SkillGroups.BionicSkills.Id, new List<SkillPerk>
				{
					Db.Get().SkillPerks.ExtraBionicBooster4,
					Db.Get().SkillPerks.IncreaseAthleticsBionicsB2
				}, new List<string> { this.BionicsB1.Id }, GameTags.Minions.Models.Bionic.Name));
				this.BionicsC1 = this.AddSkill(new Skill("BionicsC1", DUPLICANTS.ROLES.BIONICS_C1.NAME, DUPLICANTS.ROLES.BIONICS_C1.DESCRIPTION, "DLC3_ID", 0, "hat_role_craftingboosters1", "skillbadge_bionic_schematics1", Db.Get().SkillGroups.BionicSkills.Id, new List<SkillPerk>
				{
					Db.Get().SkillPerks.CanCraftElectronics,
					Db.Get().SkillPerks.IncreaseAthleticsBionicsC1
				}, new List<string>(), GameTags.Minions.Models.Bionic.Name));
				this.BionicsC2 = this.AddSkill(new Skill("BionicsC2", DUPLICANTS.ROLES.BIONICS_C2.NAME, DUPLICANTS.ROLES.BIONICS_C2.DESCRIPTION, "DLC3_ID", 1, "hat_role_craftingboosters2", "skillbadge_bionic_schematics2", Db.Get().SkillGroups.BionicSkills.Id, new List<SkillPerk>
				{
					Db.Get().SkillPerks.ExtraBionicBooster6,
					Db.Get().SkillPerks.IncreaseAthleticsBionicsC2
				}, new List<string> { this.BionicsC1.Id }, GameTags.Minions.Models.Bionic.Name));
				this.BionicsC3 = this.AddSkill(new Skill("BionicsC3", DUPLICANTS.ROLES.BIONICS_C3.NAME, DUPLICANTS.ROLES.BIONICS_C3.DESCRIPTION, "DLC3_ID", 2, "hat_role_innerworkings3", "skillbadge_bionic_gears3", Db.Get().SkillGroups.BionicSkills.Id, new List<SkillPerk> { Db.Get().SkillPerks.ExtraBionicBatteries }, new List<string>
				{
					this.BionicsB2.Id,
					this.BionicsC2.Id
