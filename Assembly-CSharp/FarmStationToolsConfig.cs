...
public class FarmStationToolsConfig : IEntityConfig
{
	...
	{
		string text = "FarmStationTools";
		string text2 = ITEMS.INDUSTRIAL_PRODUCTS.FARM_STATION_TOOLS.NAME;
		string text3 = ITEMS.INDUSTRIAL_PRODUCTS.FARM_STATION_TOOLS.DESC;
		float num = 5f;
		bool flag = true;
