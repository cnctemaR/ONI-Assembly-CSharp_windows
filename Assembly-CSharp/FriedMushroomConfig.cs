...
public class FriedMushroomConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		string text = ITEMS.FOOD.FRIEDMUSHROOM.RECIPEDESC;
		Recipe recipe = new Recipe("FriedMushroom", 1f, (SimHashes)0, null, text, 20).SetFabricator("CookingStation", FOOD.RECIPES.STANDARD_COOK_TIME);
