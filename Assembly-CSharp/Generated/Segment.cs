...
namespace Generated
{
	...
	public struct Segment
	{
		...
		public List<Segment> Stagger(float maxDistance = 10f, float staggerRange = 3f)
		{
			...
			{
				vector3 = this.e0 + vector * (1f / num) * (float)num2 + normalized * WorldGen.RandomRange(-staggerRange, staggerRange);
