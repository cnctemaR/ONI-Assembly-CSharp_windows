...
public class GeyserConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		geyser.emission_a = new Geyser.EmissionType(20f, 20f, 10f, new ElementConverter.OutputElement(1.5f, SimHashes.Steam, 423.15f, false, 0f, 0.5f, false, 1f, byte.MaxValue, 0), "");
