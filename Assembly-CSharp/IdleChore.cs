...
public class IdleChore : Chore<IdleChore.StatesInstance>
{
	public IdleChore(IStateMachineTarget target)
		: base(Db.Get().ChoreTypes.Idle, target, target.GetComponent<ChoreProvider>(), false, null, null, null, -1, false, true)
	{
		this.smi = new IdleChore.StatesInstance(this, target.gameObject);
	}

	public class StatesInstance : GameStateMachine<IdleChore.States, IdleChore.StatesInstance, IdleChore>.GameInstance
	{
	...
	public class States : GameStateMachine<IdleChore.States, IdleChore.StatesInstance, IdleChore>
	{
		public override void InitializeStates(out StateMachine.BaseState default_state)
		{
			...
			this.idle.move.TriggerOnEnter(GameHashes.BeginWalk, null).TriggerOnExit(GameHashes.EndWalk).ToggleAnims("anim_loco_walk", 0f)
				.MoveTo((IdleChore.StatesInstance smi) => smi.GetIdleCell(), this.idle, this.idle, false);
		}

		public StateMachine<IdleChore.States, IdleChore.StatesInstance, IdleChore>.BoolParameter isOnLadder;

		public StateMachine<IdleChore.States, IdleChore.StatesInstance, IdleChore>.TargetParameter idler;

		public IdleChore.States.IdleState idle;

		public class IdleState : GameStateMachine<IdleChore.States, IdleChore.StatesInstance, IdleChore>.State
		{
			public GameStateMachine<IdleChore.States, IdleChore.StatesInstance, IdleChore>.State onfloor;

			public GameStateMachine<IdleChore.States, IdleChore.StatesInstance, IdleChore>.State onladder;

			public GameStateMachine<IdleChore.States, IdleChore.StatesInstance, IdleChore>.State move;
		}
	}
}
