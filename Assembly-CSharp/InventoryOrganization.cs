...
public static class InventoryOrganization
{
	...
	private static void GenerateSubcategories()
	{
		...
		InventoryOrganization.AddSubcategory("BUILDINGS_PRINTING_POD", Def.GetUISprite("Headquarters", "ui", false).first, 750, new string[] { "permit_headquarters_ceres", "permit_porta_pod_y_ice", "permit_hqbase_cyberpunk", "permit_porta_pod_y_cyberpunk", "permit_hqbase_dino", "permit_porta_pod_y_dino", "permit_hqbase_neutronium", "permit_porta_pod_y_neutronium" });
		...
		InventoryOrganization.AddSubcategory("BUILDINGS_RANCHING", Def.GetUISprite("RanchStation", "ui", false).first, 800, new string[] { "permit_rancherstation_cottage", "permit_rancherstation_dino", "permit_rancherstation_neutronium" });
		...
		{
			"TopStandardYellow", "TopStandardRed", "TopStandardBlue", "TopStandardGreen", "permit_standard_bionic_top", "permit_top_regal_neutronium", "TopBasicBlack", "TopBasicWhite", "TopBasicRed", "TopBasicOrange",
			"TopBasicYellow", "TopBasicGreen", "TopBasicAqua", "TopBasicPurple", "TopBasicPinkOrchid"
		});
		...
		{
			"BottomBasicBlack", "permit_standard_bionic_bottom", "permit_bottom_regal_neutronium", "BottomBasicWhite", "BottomBasicRed", "BottomBasicOrange", "BottomBasicYellow", "BottomBasicGreen", "BottomBasicAqua", "BottomBasicPurple",
			"BottomBasicPinkOrchid", "PantsBasicRedOrange", "PantsBasicLightBrown", "PantsBasicOrangeSatsuma"
		});
		...
		{
			"ShoesBasicBlack", "permit_standard_bionic_shoes", "ShoesBasicWhite", "ShoesBasicRed", "ShoesBasicOrange", "ShoesBasicYellow", "ShoesBasicGreen", "ShoesBasicAqua", "ShoesBasicPurple", "ShoesBasicPinkOrchid",
			"ShoesBasicBlueGrey", "ShoesBasicTan", "ShoesBasicGray", "ShoesDenimBlue", "permit_shoes_basic_blue_wheezy", "permit_shoes_basic_frass"
		});
