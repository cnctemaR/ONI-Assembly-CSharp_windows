...
namespace Klei.AI
{
	public class CommonSickEffectDisease : Disease.DiseaseComponent
	{
		...
		{
			KBatchedAnimController kbatchedAnimController = FXHelpers.CreateEffect("contaminated_crew_fx_kanim", go.transform.position + new Vector3(0f, 0f, -0.1f), go.transform, true, Grid.SceneLayer.Front, false);
