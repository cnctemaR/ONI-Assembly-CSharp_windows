...
namespace Klei.AI
{
	public class RadiationPoisoning : Disease
	{
		public RadiationPoisoning(bool statsOnly)
			: base("RadiationSickness", 100, Disease.RangeInfo.Idempotent(), Disease.RangeInfo.Idempotent(), Disease.RangeInfo.Idempotent(), Disease.RangeInfo.Idempotent(), statsOnly)
		{
		}
