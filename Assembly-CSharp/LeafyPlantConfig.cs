...
public class LeafyPlantConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		string text2 = CREATURES.SPECIES.LEAFYPLANT.NAME;
		string text3 = CREATURES.SPECIES.LEAFYPLANT.DESC;
		float num = 1f;
