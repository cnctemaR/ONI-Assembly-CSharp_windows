...
public class LightBugCrystalConfig : IEntityConfig
{
	public static GameObject CreateLightBug(string id, string name, string desc, string anim_file, bool is_baby)
	{
		...
		tagBits.SetTag(SimHashes.Diamond.CreateTag());
		return BaseLightBugConfig.SetupDiet(gameObject, tagBits, Tag.Invalid, LightBugCrystalConfig.CALORIES_PER_KG_OF_ORE);
	}
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToFertileCreature(gameObject, "LightBugCrystalEgg", global::STRINGS.CREATURES.SPECIES.LIGHTBUG.VARIANT_CRYSTAL.EGG_NAME, global::STRINGS.CREATURES.SPECIES.LIGHTBUG.VARIANT_CRYSTAL.DESC, "egg_lightbug_kanim", "LightBugCrystalBaby", LightBugTuning.EGG_CHANCES_CRYSTAL, LightBugCrystalConfig.EGG_SORT_ORDER, true, false);
		return gameObject;
	}
