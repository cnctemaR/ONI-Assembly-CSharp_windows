...
public class LightBugOrangeConfig : IEntityConfig
{
	public static GameObject CreateLightBug(string id, string name, string desc, string anim_file, bool is_baby)
	{
		...
		tagBits.SetTag(TagManager.Create(MushroomConfig.ID));
		tagBits.SetTag(TagManager.Create("FriedMushroom"));
		tagBits.SetTag(SimHashes.Phosphorite.CreateTag());
		return BaseLightBugConfig.SetupDiet(gameObject, tagBits, Tag.Invalid, LightBugOrangeConfig.CALORIES_PER_KG_OF_ORE);
	}
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToFertileCreature(gameObject, "LightBugOrangeEgg", global::STRINGS.CREATURES.SPECIES.LIGHTBUG.VARIANT_ORANGE.EGG_NAME, global::STRINGS.CREATURES.SPECIES.LIGHTBUG.VARIANT_ORANGE.DESC, "egg_lightbug_kanim", "LightBugOrangeBaby", LightBugTuning.EGG_CHANCES_ORANGE, LightBugOrangeConfig.EGG_SORT_ORDER, true, false);
		return gameObject;
	}
