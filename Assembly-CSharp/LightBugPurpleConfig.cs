...
public class LightBugPurpleConfig : IEntityConfig
{
	public static GameObject CreateLightBug(string id, string name, string desc, string anim_file, bool is_baby)
	{
		...
		tagBits.SetTag(TagManager.Create(SpiceNutConfig.ID));
		tagBits.SetTag(TagManager.Create("SpiceBread"));
		tagBits.SetTag(SimHashes.Phosphorite.CreateTag());
		return BaseLightBugConfig.SetupDiet(gameObject, tagBits, Tag.Invalid, LightBugPurpleConfig.CALORIES_PER_KG_OF_ORE);
	}
	...
	public GameObject CreatePrefab()
	{
		...
		EntityTemplates.ExtendEntityToFertileCreature(gameObject, "LightBugPurpleEgg", global::STRINGS.CREATURES.SPECIES.LIGHTBUG.VARIANT_PURPLE.EGG_NAME, global::STRINGS.CREATURES.SPECIES.LIGHTBUG.VARIANT_PURPLE.DESC, "egg_lightbug_kanim", "LightBugPurpleBaby", LightBugTuning.EGG_CHANCES_PURPLE, LightBugPurpleConfig.EGG_SORT_ORDER, true, false);
		return gameObject;
	}
