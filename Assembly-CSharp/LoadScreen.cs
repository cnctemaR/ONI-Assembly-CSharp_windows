...
public class LoadScreen : KModalScreen
{
	...
	{
		return gameInfo.saveMajorVersion > 7 || (gameInfo.saveMajorVersion == 7 && gameInfo.saveMinorVersion > 37) || header.buildVersion > 720697U;
	}
	...
	public static void DoLoad(string filename)
	{
		...
		string text = null;
		string text2 = null;
		if (header.buildVersion > 720697U)
		{
			text = header.buildVersion.ToString();
			text2 = 720697U.ToString();
		}
