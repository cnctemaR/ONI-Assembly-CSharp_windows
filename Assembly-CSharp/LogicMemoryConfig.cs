...
public class LogicMemoryConfig : IBuildingConfig
{
	...
	{
		new LogicPorts.Port(LogicMemory.READ_PORT_ID, new CellOffset(0, 1), global::STRINGS.BUILDINGS.PREFABS.LOGICMEMORY.READ_PORT_DESC, true, LogicPortSpriteType.Output)
	};
}
