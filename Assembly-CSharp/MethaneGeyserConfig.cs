...
public class MethaneGeyserConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		geyser.emission_a = new Geyser.EmissionType(60f, 60f, 60f, new ElementConverter.OutputElement(0.75f, SimHashes.Methane, 423.15f, false, 1f, 1f, false, 1f, byte.MaxValue, 0), "");
