...
internal class NestingPoopState : GameStateMachine<NestingPoopState, NestingPoopState.Instance, IStateMachineTarget, NestingPoopState.Def>
{
	public override void InitializeStates(out StateMachine.BaseState default_state)
	{
		...
		this.goingtopoop.MoveTo((NestingPoopState.Instance smi) => smi.GetPoopPosition(), this.pooping, this.pooping, false);
		...
		state.ToggleStatusItem(text, text2, string.Empty, StatusItem.IconType.Info, NotificationType.Neutral, false, SimViewMode.None, 63486, null, null, main).PlayAnim("poop").OnAnimQueueComplete(this.behaviourcomplete);
	...
	public new class Instance : GameStateMachine<NestingPoopState, NestingPoopState.Instance, IStateMachineTarget, NestingPoopState.Def>.GameInstance
	{
		...
		public int GetPoopPosition()
		{
			...
			{
				global::Debug.LogWarning("This is bad, how is Mole occupying an invalid cell?", null);
			}
