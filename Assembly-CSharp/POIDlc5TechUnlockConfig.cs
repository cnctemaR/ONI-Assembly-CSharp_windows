...
public class POIDlc5TechUnlockConfig : IEntityConfig, IHasDlcRestrictions
{
	...
	{
		string text = "POIDlc5TechUnlock";
		string text2 = global::STRINGS.BUILDINGS.PREFABS.DLC5POITECHUNLOCKS.NAME;
		string text3 = global::STRINGS.BUILDINGS.PREFABS.DLC5POITECHUNLOCKS.DESC;
		float num = 100f;
		EffectorValues tier = global::TUNING.BUILDINGS.DECOR.BONUS.TIER0;
		EffectorValues tier2 = NOISE_POLLUTION.NOISY.TIER0;
		GameObject gameObject = EntityTemplates.CreatePlacedEntity(text, text2, text3, num, Assets.GetAnim("research_unlock_aquatic_kanim"), "on", Grid.SceneLayer.Building, 3, 3, tier, tier2, SimHashes.Creature, new List<Tag>
		{
			GameTags.Gravitas,
		...
		def.PopUpName = global::STRINGS.BUILDINGS.PREFABS.DLC5POITECHUNLOCKS.NAME;
