...
public class PressureSwitchLiquidConfig : IBuildingConfig
{
	public override BuildingDef CreateBuildingDef()
	{
		...
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(PressureSwitchLiquidConfig.ID, 1, 1, "switchliquidpressure_kanim", 1000f, 30, 30f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER3, MATERIALS.ALL_METALS, 1600f, BuildLocationRule.Anywhere, BUILDINGS.DECOR.PENALTY.TIER0, none);
