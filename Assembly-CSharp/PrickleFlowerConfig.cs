...
public class PrickleFlowerConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		}, true, 0f, 0.15f, PrickleFruitConfig.ID, true, true, true, true, 2400f);
