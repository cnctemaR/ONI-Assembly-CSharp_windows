...
public class PropFacilityCouchConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		GameObject gameObject = EntityTemplates.CreatePlacedEntity(text, text2, text3, num, Assets.GetAnim("gravitas_couch_kanim"), "off", Grid.SceneLayer.Building, 4, 2, tier, tier2, SimHashes.Creature, null, 293f);
