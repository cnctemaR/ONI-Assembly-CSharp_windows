...
public class PropFacilityTableConfig : IEntityConfig
{
	...
	{
		GameObject gameObject = EntityTemplates.CreatePlacedEntity("PropFacilityTable", SETITEMS.FACILITY_TABLE.NAME, SETITEMS.FACILITY_TABLE.DESC, 50f, Assets.GetAnim("gravitas_table_kanim"), "off", Grid.SceneLayer.Building, 4, 2, global::TUNING.BUILDINGS.DECOR.BONUS.TIER0, NOISE_POLLUTION.NOISY.TIER0, SimHashes.Creature, null, 293f);
