...
public class ReportManager : KMonoBehaviour
{
	public ReportManager()
	{
		...
		dictionary.Add(ReportManager.ReportType.TimeSpent, new ReportManager.ReportGroup((float v) => GameUtil.GetFormattedTime(v), true, 2, UI.ENDOFDAYREPORT.TIME_SPENT.NAME, UI.ENDOFDAYREPORT.TIME_SPENT.POSITIVE_TOOLTIP, string.Empty));
