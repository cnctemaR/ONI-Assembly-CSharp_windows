...
public class ResearchTypes
{
	...
	{
		ResearchType researchType = new ResearchType(ResearchTypes.ID.ALPHA, RESEARCH.TYPES.ALPHA.NAME, RESEARCH.TYPES.ALPHA.DESC, Assets.GetSprite("research_type_alpha_icon"), new Color(0.59607846f, 0.6666667f, 0.9137255f), new Recipe.Ingredient[]
		{
		...
		ResearchType researchType2 = new ResearchType(ResearchTypes.ID.BETA, RESEARCH.TYPES.BETA.NAME, RESEARCH.TYPES.BETA.DESC, Assets.GetSprite("research_type_beta_icon"), new Color(0.6f, 0.38431373f, 0.5686275f), new Recipe.Ingredient[]
		{
