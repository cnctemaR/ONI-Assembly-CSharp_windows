...
public class ResetSkillsStation : Workable
{
	...
	protected override void OnCompleteWork(Worker worker)
	{
		...
		if (component != null)
		{
			...
			this.notification = new Notification(MISC.NOTIFICATIONS.RESETSKILL.NAME, NotificationType.Good, (List<Notification> notificationList, object data) => MISC.NOTIFICATIONS.RESETSKILL.TOOLTIP + notificationList.ReduceMessages(false), null, true, 0f, null, null, null, true);
