...
public class RolePerks
{
	public RolePerks()
	{
		...
		this.IncreaseConstructionSmall = new RoleAttributePerk("IncreaseConstructionSmall", UI.ROLES_SCREEN.PERKS.INCREASED_CONSTRUCTION.DESCRIPTION, Db.Get().Attributes.Construction.Id, (float)ROLES.ATTRIBUTE_BONUS_FIRST, DUPLICANTS.ROLES.BUILDER.NAME);
		...
		this.IncreaseConstructionLarge = new RoleAttributePerk("IncreaseConstructionLarge", UI.ROLES_SCREEN.PERKS.INCREASED_CONSTRUCTION.DESCRIPTION, Db.Get().Attributes.Construction.Id, (float)ROLES.ATTRIBUTE_BONUS_THIRD, DUPLICANTS.ROLES.BUILDER.NAME);
		...
		this.IncreaseBotanySmall = new RoleAttributePerk("IncreaseBotanySmall", UI.ROLES_SCREEN.PERKS.INCREASE_BOTANIST.DESCRIPTION, Db.Get().Attributes.Botanist.Id, (float)ROLES.ATTRIBUTE_BONUS_SECOND, DUPLICANTS.ROLES.JUNIOR_FARMER.NAME);
		...
		this.IncreaseBotanyLarge = new RoleAttributePerk("IncreaseBotanyLarge", UI.ROLES_SCREEN.PERKS.INCREASE_BOTANIST.DESCRIPTION, Db.Get().Attributes.Botanist.Id, (float)ROLES.ATTRIBUTE_BONUS_SECOND, DUPLICANTS.ROLES.SENIOR_FARMER.NAME);
		this.CanFarmTinker = new SimpleRolePerk("CanFarmTinker", UI.ROLES_SCREEN.PERKS.CAN_FARM_TINKER.DESCRIPTION);
		this.IncreaseRanchingSmall = new RoleAttributePerk("IncreaseRanchingSmall", UI.ROLES_SCREEN.PERKS.INCREASE_RANCHING.DESCRIPTION, Db.Get().Attributes.Ranching.Id, (float)ROLES.ATTRIBUTE_BONUS_SECOND, DUPLICANTS.ROLES.RANCHER.NAME);
		...
		this.IncreaseAthleticsMedium = new RoleAttributePerk("IncreaseAthletics", UI.ROLES_SCREEN.PERKS.INCREASED_ATHLETICS.DESCRIPTION, Db.Get().Attributes.Athletics.Id, (float)ROLES.ATTRIBUTE_BONUS_SECOND, DUPLICANTS.ROLES.HAULER.NAME);
		...
		this.IncreaseMachineryMedium = new RoleAttributePerk("IncreaseMachineryMedium", UI.ROLES_SCREEN.PERKS.INCREASED_MACHINERY.DESCRIPTION, Db.Get().Attributes.Machinery.Id, (float)ROLES.ATTRIBUTE_BONUS_SECOND, DUPLICANTS.ROLES.MACHINE_TECHNICIAN.NAME);
