...
public class RolePerks
{
	public RolePerks()
	{
		this.IncreaseDigSpeedSmall = new RoleAttributePerk("IncreaseDigSpeedSmall", UI.ROLES_SCREEN.PERKS.INCREASED_DIG_SPEED.DESCRIPTION, Db.Get().Attributes.Digging.Id, (float)ROLES.ATTRIBUTE_BONUS_SMALL, DUPLICANTS.ROLES.MINER.NAME);
		...
		this.IncreaseDigSpeedLarge = new RoleAttributePerk("IncreaseDigSpeedLarge", UI.ROLES_SCREEN.PERKS.INCREASED_DIG_SPEED.DESCRIPTION, Db.Get().Attributes.Digging.Id, (float)ROLES.ATTRIBUTE_BONUS_LARGE, DUPLICANTS.ROLES.MINER.NAME);
		...
		this.IncreaseLearningSmall = new RoleAttributePerk("IncreaseLearningSmall", UI.ROLES_SCREEN.PERKS.INCREASED_LEARNING.DESCRIPTION, Db.Get().Attributes.Learning.Id, (float)ROLES.ATTRIBUTE_BONUS_SMALL, DUPLICANTS.ROLES.RESEARCHER.NAME);
		...
		this.IncreaseLearningLarge = new RoleAttributePerk("IncreaseLearningLarge", UI.ROLES_SCREEN.PERKS.INCREASED_LEARNING.DESCRIPTION, Db.Get().Attributes.Learning.Id, (float)ROLES.ATTRIBUTE_BONUS_LARGE, DUPLICANTS.ROLES.RESEARCHER.NAME);
		this.IncreaseBotanySmall = new RoleAttributePerk("IncreaseBotanySmall", UI.ROLES_SCREEN.PERKS.INCREASE_BOTANIST.DESCRIPTION, Db.Get().Attributes.Botanist.Id, (float)ROLES.ATTRIBUTE_BONUS_MEDIUM, DUPLICANTS.ROLES.FARMER.NAME);
		...
		this.IncreaseBotanyLarge = new RoleAttributePerk("IncreaseBotanyLarge", UI.ROLES_SCREEN.PERKS.INCREASE_BOTANIST.DESCRIPTION, Db.Get().Attributes.Botanist.Id, (float)ROLES.ATTRIBUTE_BONUS_MEDIUM, DUPLICANTS.ROLES.FARMER.NAME);
		...
		this.IncreaseStrengthMedium = new RoleAttributePerk("IncreaseStrength", UI.ROLES_SCREEN.PERKS.INCREASED_STRENGTH.DESCRIPTION, Db.Get().Attributes.Strength.Id, (float)ROLES.ATTRIBUTE_BONUS_MEDIUM, DUPLICANTS.ROLES.HAULER.NAME);
		...
		this.IncreaseCarryAmountMedium = new RoleAttributePerk("IncreaseCarryAmountMedium", UI.ROLES_SCREEN.PERKS.INCREASED_CARRY_AMOUNT.DESCRIPTION, Db.Get().Attributes.CarryAmount.Id, 800f, DUPLICANTS.ROLES.HAULER.NAME);
		...
		this.IncreaseCookingSmall = new RoleAttributePerk("IncreaseCookingSmall", UI.ROLES_SCREEN.PERKS.INCREASED_COOKING.DESCRIPTION, Db.Get().Attributes.Cooking.Id, (float)ROLES.ATTRIBUTE_BONUS_SMALL, DUPLICANTS.ROLES.COOK.NAME);
