...
public class RubberTileConfig : IBuildingConfig
{
	...
	{
		string text = "RubberTile";
		int num = 1;
		int num2 = 1;
		string text2 = "floor_rubber_kanim";
		int num3 = 30;
		float num4 = 30f;
		float[] tier = global::TUNING.BUILDINGS.CONSTRUCTION_MASS_KG.TIER2;
		string[] array = new string[] { SimHashes.Rubber.CreateTag().ToString() };
		float num5 = 1600f;
	...
	public override void DoPostConfigureComplete(GameObject go)
	{
		...
		go.GetComponent<KPrefabID>().AddTag(GameTags.PreventsSlipping, false);
	}
