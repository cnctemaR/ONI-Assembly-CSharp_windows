	...
	public class BUILDING
	{
		public class STATUSITEMS
		{
			...
			public class COLONYLACKSREQUIREDSKILLPERK
			{
				...
				public static LocString TOOLTIP_CLUSTER = " on this " + UI.CLUSTERMAP.PLANETOID_KEYWORD + ", or bring in a Duplicant with the appropriate skill from another " + UI.CLUSTERMAP.PLANETOID;
			}
			...
			public class HIGHENERGYPARTICLEREDIRECTOR
			{
				...
				public class TOOLTIPS
				{
					...
					{
						"Particle Redirector is receiving a ",
			...
			public class HIGHENERGYPARTICLESPAWNER
			{
				...
				public class TOOLTIPS
				{
					public static LocString LOGIC_CONTROLLED_STANDBY = string.Concat(new string[]
					{
						"Particle Generator is receiving a ",
						UI.FormatAsAutomationState("Red Signal", UI.AutomationState.Standby),
						", ignoring incoming ",
						UI.PRE_KEYWORD,
						"High Energy Particles",
			...
			public class ROCKETCARGOEMPTYING
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					...
					"Rocket Platform",
					UI.PST_KEYWORD,
					" is unloading available resources from the rocket to the material ports\n\nLoading will proceed afterwards"
				});
			}
			...
			public class ROCKETCARGOFILLING
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					...
					"Rocket Platform",
					UI.PST_KEYWORD,
					" is loading available resources from the material ports to the rocket\n\nUnloading has been completed"
				});
			}
			...
			public class ROCKET_PORT_UNLOADING
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					"This port is unloading resources from the ",
					UI.PRE_KEYWORD,
					"Rocket Platform",
					UI.PST_KEYWORD,
					" to the connected pipe network"
				});
			}
			...
			public class ROCKET_PORT_LOADING
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					"This port is transferring resources into the connected ",
					UI.PRE_KEYWORD,
					"Rocket Platform's",
					UI.PST_KEYWORD,
					" landed rocket"
			...
			public class ROCKET_PORT_LOADED
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					"The rocket on the connected ",
					UI.PRE_KEYWORD,
					"Rocket Platform",
					UI.PST_KEYWORD,
					" is either full of this type of resource or has no matching storage modules"
				});
			}
			...
			public class CONNECTED_ROCKET_PORT
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					...
					" which can load or unload from this module"
				});
			}
			...
			public class CONNECTED_ROCKET_WRONG_PORT
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					...
					"Rocket Platform",
					UI.PST_KEYWORD,
					" are not the correct type for this ",
					UI.PRE_KEYWORD,
					"Cargo Bay",
					UI.PST_KEYWORD
				});
			...
			public class CONNECTED_ROCKET_NO_PORT
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					...
					" ",
					BUILDINGS.PREFABS.MODULARLAUNCHPADPORT.NAME,
					" are required to load and unload materials from a landed rocket's ",
					UI.PRE_KEYWORD,
					"Cargo Bays",
					UI.PST_KEYWORD
				});
