		...
		public class STATUSITEMS
		{
			...
			public class GASVENTOBSTRUCTED
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					...
					"Pipe",
					UI.PST_KEYWORD,
					" has been obstructed and is preventing gas flow to this vent"
				});
			}
			...
			public class LIQUIDVENTOBSTRUCTED
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					...
					"Pipe",
					UI.PST_KEYWORD,
					" has been obstructed and is preventing liquid flow to this vent"
				});
			}
			...
			public class TURBINE_ACTIVE_WATTAGE
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					...
					"Power",
					UI.PST_KEYWORD,
					"\n\nIt is running at <b>{Efficiency}</b> of full capacity. Increase {Src_Element} ",
					UI.PRE_KEYWORD,
					"Mass",
					UI.PST_KEYWORD,
					" and ",
