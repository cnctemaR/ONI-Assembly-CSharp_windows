...
namespace STRINGS
{
	public class CODEX
	{
		public class HEADERS
		{
			...
			public static LocString UNLOCK_ROLES = "Promotable to Roles";
			...
			public static LocString SUBENTRIES = "Contents";
		...
		public class NEGA
		{
			public static LocString TITLE = "Nega Shine Bug";
		...
		{
			public static LocString TITLE = "Crystal Shine Bug";
		...
		public class SUNNY
		{
			public static LocString TITLE = "Sunny Shine Bug";
		...
		public class PLACID
		{
			public static LocString TITLE = "Placid Shine Bug";
		...
		public class VITAL
		{
			public static LocString TITLE = "Vital Shine Bug";
		...
		public class ROYAL
		{
			public static LocString TITLE = "Royal Shine Bug";
		...
		{
			public static LocString TITLE = "Example Title";

			public static LocString SUBTITLE = "Example Subtitle";
		}
