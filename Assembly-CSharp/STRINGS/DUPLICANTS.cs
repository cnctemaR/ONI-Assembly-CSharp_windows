	...
	public class DUPLICANTS
	{
		...
		public class MODIFIERS
		{
			...
			public class SEAFOODRADIATIONRESISTANCE
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					"This Duplicant ate seafood and is now more ",
					UI.PRE_KEYWORD,
					"Radiation",
					UI.PST_KEYWORD,
					" resistant"
		...
		public class ROLES
		{
			...
			public class ROCKETPILOT
			{
				...
				public static LocString DESCRIPTION = "Allows a Duplicant to operate a " + BUILDINGS.PREFABS.ROCKETCOMMANDCONSOLE.NAME + " and pilot rockets";
			}
