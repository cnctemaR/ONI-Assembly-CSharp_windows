	...
	public class MISC
	{
		...
		public class NOTIFICATIONS
		{
			...
			public class WORLDDETECTED
			{
				...
				public static LocString MESSAGEBODY = "The Duplicants' astrological efforts have uncovered new " + UI.CLUSTERMAP.PLANETOID + "s:\n{0}";
			...
			public class HEALINGTRAITGAIN
			{
				...
				public static LocString TOOLTIP = string.Concat(new string[]
				{
					"These Duplicants' injuries weren't set and healed improperly. They developed ",
					UI.PRE_KEYWORD,
					"Traits",
					UI.PST_KEYWORD,
					" as a result:"
