...
namespace STRINGS
{
	public class RESEARCH
	{
		public class MESSAGING
		{
			...
			public static LocString NO_RESEARCHER_SKILL_TOOLTIP = string.Concat(new string[]
			{
				"The selected research focus requires ",
				UI.PRE_KEYWORD,
				"Advanced Research",
				UI.PST_KEYWORD,
				" to complete\n\nOpen the ",
				UI.FormatAsManagementMenu("Skills Panel", "[L]"),
				" and teach a Duplicant the ",
				RESEARCH.TECHS.ADVANCEDRESEARCH.NAME,
				" Skill to use this building"
			});
