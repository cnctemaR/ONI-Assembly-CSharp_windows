...
namespace STRINGS
{
	public class RESEARCH
	{
		...
		{
			public static LocString NAME = "Gas Piping";
		...
		{
			public static LocString NAME = "Liquid Piping";
		...
		public class MEDBAY
		{
			public static LocString NAME = "Medbay";

			public static LocString DESC = "<style=\"medicine\">Medicines</style> to stop injury and <style=\"disease\">Disease</style> from running rampant in your colony.";
		}

		public class PERCOLATION
		{
			public static LocString NAME = "Percolation";

			public static LocString DESC = "Waste management techniques to keep your base clean and livable.";
		}
