...
public class SafetyConditions
{
	public SafetyConditions()
	{
		...
		this.HasSomeOxygen = new SafetyChecker.Condition("HasSomeOxygen", num *= 2, (int cell, int cost, SafetyChecker.Context context) => context.oxygenBreather == null || GasBreatherFromWorldProvider.GetBestBreathableCellAroundSpecificCell(cell, new CellOffset[]
		{
			CellOffset.none,
			CellOffset.up
