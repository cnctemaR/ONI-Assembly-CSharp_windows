...
public class SalsaConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		gameObject = EntityTemplates.ExtendEntityToFood(gameObject, FOOD.FOOD_TYPES.SALSA, true);
		string text = ITEMS.FOOD.SALSA.RECIPEDESC;
		Recipe recipe = new Recipe("Salsa", 1f, (SimHashes)0, null, text, 101).SetFabricator("CookingStation", FOOD.RECIPES.STANDARD_COOK_TIME);
