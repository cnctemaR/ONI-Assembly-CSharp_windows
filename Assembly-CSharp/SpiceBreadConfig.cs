...
public class SpiceBreadConfig : IEntityConfig
{
	public GameObject CreatePrefab()
	{
		...
		string text = ITEMS.FOOD.SPICEBREAD.RECIPEDESC;
		Recipe recipe = new Recipe("SpiceBread", 1f, (SimHashes)0, null, text, 100).SetFabricator("CookingStation", FOOD.RECIPES.STANDARD_COOK_TIME);
