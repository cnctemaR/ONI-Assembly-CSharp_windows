...
public class SteamEngineClusterConfig : IBuildingConfig
{
	...
	public override void DoPostConfigureComplete(GameObject go)
	{
		...
		BuildingTemplates.ExtendBuildingToRocketModuleCluster(go, null, ROCKETRY.BURDEN.MODERATE, (float)ROCKETRY.ENGINE_POWER.MID_WEAK, ROCKETRY.FUEL_COST_PER_DISTANCE.GAS_HIGH);
