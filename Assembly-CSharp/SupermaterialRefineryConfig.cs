...
public class SupermaterialRefineryConfig : IBuildingConfig
{
	...
	public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag)
	{
		...
		if (DlcManager.IsAllContentSubscribed(new string[] { "DLC3_ID", "EXPANSION1_ID" }))
		{
			...
			ComplexRecipe complexRecipe5 = new ComplexRecipe(ComplexRecipeManager.MakeRecipeID("SupermaterialRefinery", array9, array10), array9, array10, DlcManager.EXPANSION1.Append<string>(DlcManager.DLC3));
