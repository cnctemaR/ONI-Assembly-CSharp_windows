...
namespace TMPro.Examples
{
	public class TextMeshProFloatingText : MonoBehaviour
	{
		...
		public IEnumerator DisplayTextMeshProFloatingText()
		{
			...
			yield return TextMeshProFloatingText.k_WaitForSecondsRandom[global::UnityEngine.Random.Range(0, 19)];
		...
		public IEnumerator DisplayTextMeshFloatingText()
		{
			...
			yield return TextMeshProFloatingText.k_WaitForSecondsRandom[global::UnityEngine.Random.Range(0, 20)];
			this.m_floatingText_Transform.position = start_pos;
			base.StartCoroutine(this.DisplayTextMeshFloatingText());
			yield break;
		}
