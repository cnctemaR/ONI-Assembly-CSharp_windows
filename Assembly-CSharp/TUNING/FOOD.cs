...
namespace TUNING
{
	public class FOOD
	{
		...
		public class FOOD_TYPES
		{
			...
			public static readonly EdiblesManager.FoodInfo BURGER = new EdiblesManager.FoodInfo("Burger", 6000000f, 6, 255.15f, 277.15f, 1200f, true).AddEffects(new List<string> { "GoodEats" });
