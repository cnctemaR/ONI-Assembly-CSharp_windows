...
namespace TUNING
{
	public class TRAITS
	{
		...
		public static readonly List<global::System.Action> TRAIT_CREATORS = new List<global::System.Action>
		{
			...
			TraitUtil.CreateSkillGrantingTrait("GrantSkill_Swimming2", DUPLICANTS.TRAITS.GRANTSKILL_SWIMMING2.NAME, DUPLICANTS.TRAITS.GRANTSKILL_SWIMMING2.DESC, new string[] { "Swimming", "Swimming2" }),
