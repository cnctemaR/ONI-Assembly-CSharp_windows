...
public class TemperatureSuitConfig : IEquipmentConfig
{
	public EquipmentDef CreateEquipmentDef()
	{
		...
		float num = (float)global::TUNING.EQUIPMENT.SUITS.TEMPERATURESUIT_MASS;
		...
		EquipmentDef equipmentDef = EquipmentTemplates.CreateEquipmentDef(text, slot, simHashes, num, anim, snapon, text2, num2, list2, null, false, EntityTemplates.CollisionShape.CIRCLE, 0.325f, 0.325f, array, null);
