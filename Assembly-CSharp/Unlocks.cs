	...
	public Dictionary<string, string[]> lockCollections = new Dictionary<string, string[]>
	{
		...
		},
		{
			...
			new string[]
			{
				...
				"journal_cleanup", "journal_A046_4", "journal_B327_4", "journal_revisitednumbers", "journal_B556_4", "journal_B835_5", "journal_elliesbirthday2", "journal_revisitednumbers2", "journal_timemusings"
			}
		},
		{
			"researchnotes",
