...
public class WireBridgeHighWattageConfig : IBuildingConfig
{
	public override BuildingDef CreateBuildingDef()
	{
		...
		BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef("WireBridgeHighWattage", 1, 1, "heavywatttile_kanim", 100f, 30, 3f, BUILDINGS.CONSTRUCTION_MASS_KG.TIER3, MATERIALS.ALL_METALS, 1600f, BuildLocationRule.NotInTiles, BUILDINGS.DECOR.PENALTY.TIER5, none);
