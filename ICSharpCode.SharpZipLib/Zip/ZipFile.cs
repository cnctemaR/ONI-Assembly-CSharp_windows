...
namespace ICSharpCode.SharpZipLib.Zip
{
	public class ZipFile : IDisposable, IEnumerable
	{
		...
		public bool TestArchive(bool testData, TestStrategy strategy, ZipTestResultHandler resultHandler)
		{
			...
			ZipFile.HeaderTest headerTest = ((!testData) ? ZipFile.HeaderTest.Header : (ZipFile.HeaderTest.Extract | ZipFile.HeaderTest.Header));
			bool flag = true;
			try
			{
				int num = 0;
		...
		public void CommitUpdate()
		{
			...
			try
			{
				...
				{
					byte[] array = ((this.newComment_ == null) ? ZipConstants.ConvertToArray(this.comment_) : this.newComment_.RawComment);
