...
namespace ImGuiNET
{
	public struct StbUndoState
	{
		...
		[FixedBuffer(typeof(ushort), 999)]
		public StbUndoState.<undo_char>e__FixedBuffer undo_char;
		...
		[CompilerGenerated]
		[UnsafeValueType]
		[StructLayout(LayoutKind.Sequential, Size = 1998)]
		public struct <undo_char>e__FixedBuffer
		{
