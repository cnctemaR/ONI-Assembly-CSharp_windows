...
namespace Newtonsoft.Json.Schema
{
	...
	internal class JsonSchemaNode
	{
		...
		{
			return string.Join("-", schemata.Select<JsonSchema, string>((JsonSchema s) => s.InternalId).OrderBy<string, string>((string id) => id, StringComparer.Ordinal).ToArray<string>());
		}
	}
}
