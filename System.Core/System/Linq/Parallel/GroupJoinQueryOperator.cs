...
namespace System.Linq.Parallel
{
	internal sealed class GroupJoinQueryOperator<TLeftInput, TRightInput, TKey, TOutput> : BinaryQueryOperator<TLeftInput, TRightInput, TOutput>
	{
		...
		internal override IEnumerable<TOutput> AsSequentialQuery(CancellationToken token)
		{
			...
			return enumerable.GroupJoin<TLeftInput, TRightInput, TKey, TOutput>(enumerable2, this._leftKeySelector, this._rightKeySelector, this._resultSelector, this._keyComparer);
		}
