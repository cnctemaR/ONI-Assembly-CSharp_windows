	...
	public class FontConverter : TypeConverter
	{
		...
		public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
		{
			...
			if (destinationType == typeof(InstanceDescriptor) && value is Font)
			{
				...
				ConstructorInfo constructor = typeof(Font).GetConstructor(new Type[]
				{
					typeof(string),
					typeof(float),
					typeof(FontStyle),
				...
				return new InstanceDescriptor(constructor, new object[] { font2.Name, font2.Size, font2.Style, font2.Unit });
			}
		...
		public override object CreateInstance(ITypeDescriptorContext context, IDictionary propertyValues)
		{
			...
			{
				graphicsUnit = (GraphicsUnit)((int)obj);
			}
			...
			if ((obj = propertyValues["Bold"]) != null)
			{
				bool flag2 = (bool)obj;
				if (flag2)
				{
			...
			if ((obj = propertyValues["Italic"]) != null)
			{
				bool flag3 = (bool)obj;
				if (flag3)
				{
			...
			if ((obj = propertyValues["Strikeout"]) != null)
			{
				bool flag4 = (bool)obj;
				if (flag4)
				{
			...
			if ((obj = propertyValues["Underline"]) != null)
			{
				bool flag5 = (bool)obj;
				if (flag5)
				{
			...
			else
			{
				...
				if (fontFamily == null)
				{
					...
					FontFamily[] families2 = fontCollection.Families;
					foreach (FontFamily fontFamily3 in families2)
					{
