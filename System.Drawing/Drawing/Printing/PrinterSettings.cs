...
namespace System.Drawing.Printing
{
	...
	public class PrinterSettings : ICloneable
	{
		...
		public override string ToString()
		{
			...
			{
				"Printer [PrinterSettings ", this.printer_name, " Copies=", this.copies, " Collate=", this.collate, " Duplex=", this.can_duplex, " FromPage=", this.from_page,
				" LandscapeAngle=", this.landscape_angle, " MaximumCopies=", this.maximum_copies, " OutputPort= ToPage=", this.to_page, "]"
			});
		}
