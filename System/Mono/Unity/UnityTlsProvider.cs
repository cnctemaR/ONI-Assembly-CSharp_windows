			...
			try
			{
				...
				if (validator.Settings.TrustAnchors != null)
				{
					...
					try
					{
						...
						unitytls_x509verify_result = UnityTls.NativeInterface.unitytls_x509verify_explicit_ca(unitytls_x509list_ref, unitytls_x509list_ref2, ptr3, bytes.Length, null, null, &unitytls_errorstate);
					}
					finally
					{
						byte[] array = null;
				...
				else
				{
					try
					{
						...
						unitytls_x509verify_result = UnityTls.NativeInterface.unitytls_x509verify_default_ca(unitytls_x509list_ref, ptr4, bytes.Length, null, null, &unitytls_errorstate);
					}
					finally
					{
						byte[] array = null;
