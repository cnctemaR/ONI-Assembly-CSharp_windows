	...
	public static class xxHash3
	{
		...
		internal static class Hash64Long_0000071F$BurstDirectCall
		{
			...
			private static IntPtr GetFunctionPointer()
			{
				...
				xxHash3.Hash64Long_0000071F$BurstDirectCall.GetFunctionPointerDiscard(ref intPtr);
				return intPtr;
			}
		...
		internal static class Hash128Long_00000726$BurstDirectCall
		{
			...
			{
				IntPtr intPtr = (IntPtr)0;
				xxHash3.Hash128Long_00000726$BurstDirectCall.GetFunctionPointerDiscard(ref intPtr);
				return intPtr;
			}

			public unsafe static void Constructor()
			{
				xxHash3.Hash128Long_00000726$BurstDirectCall.DeferredCompilation = BurstCompiler.CompileILPPMethod2(methodof(xxHash3.Hash128Long(byte*, byte*, long, byte*, ref uint4)).MethodHandle);
			}
