			...
			else
			{
				...
				while (i < this.m_characterCount)
				{
					...
					if (flag13)
					{
						...
						if (!flag2 && flag14 && i <= tmp_LineInfo.lastVisibleCharacterIndex && character3 != '\n' && character3 != '\r' && (i != tmp_LineInfo.lastVisibleCharacterIndex || !char.IsSeparator(character3)))
						{
							flag2 = true;
					...
					if ((this.m_textInfo.characterInfo[i].style & FontStyles.Highlight) == FontStyles.Highlight)
					{
						...
						if (!flag3 && flag15 && i <= tmp_LineInfo.lastVisibleCharacterIndex && character3 != '\n' && character3 != '\r' && (i != tmp_LineInfo.lastVisibleCharacterIndex || !char.IsSeparator(character3)))
						{
							flag3 = true;
					...
					if ((!char.IsControl(character4) && lineNumber4 < this.m_lineNumber) || flag17 || tmp_LineInfo.maxAdvance > tmp_LineInfo.width)
					{
