...
namespace TMPro
{
	...
	public class TextMeshPro : TMP_Text, ILayoutElement
	{
		...
		protected override void Awake()
		{
			...
			{
				this.m_mesh = new Mesh();
				this.m_mesh.name = "TMPro_Private";
				this.m_mesh.hideFlags = HideFlags.HideAndDontSave;
		...
		protected override void GenerateTextMesh()
		{
			...
			while (num14 < this.m_char_buffer.Length && this.m_char_buffer[num14] != 0)
			{
				...
				if (this.m_textElementType == TMP_TextElementType.Sprite)
				{
					...
					float num17 = this.m_currentFontSize / this.m_currentFontAsset.fontInfo.PointSize * this.m_currentFontAsset.fontInfo.Scale * ((!this.m_isOrthographic) ? 0.1f : 1f);
			...
			else
			{
				...
				int num42 = this.m_materialReferences[0].referenceCount * (this.m_isVolumetricText ? 8 : 4);
				...
				bool flag11 = false;
				int num48 = 0;
				float num49 = (this.m_previousLossyScaleY = this.transform.lossyScale.y);
				...
				while (i < this.m_characterCount)
				{
					...
					if (isVisible)
					{
						...
						else
						{
							...
							num50 = characterInfo[i].scale * num49 * (1f - this.m_charWidthAdjDelta);
						...
						if (elementType == TMP_TextElementType.Character)
						{
							this.FillCharacterVertexBuffers(i, num43, this.m_isVolumetricText);
						}
					...
					if ((!char.IsControl(character4) && lineNumber4 < this.m_lineNumber) || flag19 || tmp_LineInfo.maxAdvance > tmp_LineInfo.width)
					{
