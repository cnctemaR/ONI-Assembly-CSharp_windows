...
namespace Unity.Hierarchy
{
	...
	{
		internal HierarchyViewNodesEnumerable(HierarchyViewModel viewModel, HierarchyNodeFlags flags, HierarchyViewNodesEnumerable.PredicateCallback predicate)
		{
			if (viewModel == null)
			{
		...
		private readonly HierarchyViewNodesEnumerable.PredicateCallback m_Predicate;
