...
namespace UnityEngine.LowLevelPhysics2D
{
	public readonly struct PhysicsSliderJoint : IPhysicsJoint, IEquatable<PhysicsSliderJoint>
	{
		...
		{
			bool flag = physicsJoint.jointType != PhysicsJoint.JointType.SliderJoint;
			if (flag)
			{
		...
		public float currentMotorForce
		{
			get
			{
				return PhysicsLowLevelScripting2D.SliderJoint_GetCurrentMotorForce(this);
			}
		}
		...
		public float currentTranslation
		{
			get
			{
				return PhysicsLowLevelScripting2D.SliderJoint_GetCurrentTranslation(this);
			}
		}
		...
		public float currentSpeed
		{
			get
			{
				return PhysicsLowLevelScripting2D.SliderJoint_GetCurrentSpeed(this);
			}
		}
