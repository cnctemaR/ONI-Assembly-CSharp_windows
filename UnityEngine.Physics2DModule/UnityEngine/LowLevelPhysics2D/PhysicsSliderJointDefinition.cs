...
namespace UnityEngine.LowLevelPhysics2D
{
	...
	public struct PhysicsSliderJointDefinition
	{
		...
		{
			this = PhysicsSliderJointDefinition.defaultDefinition;
		}
		...
		public static PhysicsSliderJointDefinition defaultDefinition
		{
			get
			{
				return PhysicsLowLevelScripting2D.SliderJoint_GetDefaultDefinition(true);
			}
		}
		...
		public float springTargetTranslation
		{
			readonly get
			{
				return this.m_SpringTargetTranslation;
			}
			set
			{
				this.m_SpringTargetTranslation = value;
			}
		}
		...
		public float maxMotorForce
		{
			...
			set
			{
				this.m_MaxMotorForce = Mathf.Max(0f, value);
			}
		}
