...
namespace UnityEngine.TextCore.Text
{
	...
	internal static class TextGeneratorUtilities
	{
		...
		public static Color32 HexCharsToColor(char[] hexChars, int startIndex, int tagCount)
		{
			...
			if (flag)
			{
				byte b = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 1]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 1]));
				byte b2 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 2]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 2]));
				byte b3 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 3]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 3]));
			...
			else
			{
				...
				if (flag2)
				{
					byte b4 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 1]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 1]));
					byte b5 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 2]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 2]));
					byte b6 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 3]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 3]));
					byte b7 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 4]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 4]));
				...
				else
				{
					...
					if (flag3)
					{
						byte b8 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 1]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 2]));
						byte b9 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 3]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 4]));
						byte b10 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 5]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 6]));
					...
					else
					{
						...
						if (flag4)
						{
							byte b11 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 1]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 2]));
							byte b12 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 3]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 4]));
							byte b13 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 5]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 6]));
							byte b14 = (byte)(TextGeneratorUtilities.HexToInt(hexChars[startIndex + 7]) * 16U + TextGeneratorUtilities.HexToInt(hexChars[startIndex + 8]));
		...
		public static void FillCharacterVertexBuffers(int i, bool convertToLinearSpace, TextGenerationSettings generationSettings, TextInfo textInfo, bool needToRound)
		{
			...
			if (!flag2)
			{
				...
				vector2.y *= -1f;
				textInfo.meshInfo[materialReferenceIndex].vertexData[vertexCount].position = vector2 + vector;
				vector2 = textElementInfo[i].vertexTopLeft.position;
				vector2.y *= -1f;
				textInfo.meshInfo[materialReferenceIndex].vertexData[1 + vertexCount].position = vector2 + vector;
				vector2 = textElementInfo[i].vertexTopRight.position;
				vector2.y *= -1f;
				textInfo.meshInfo[materialReferenceIndex].vertexData[2 + vertexCount].position = vector2 + vector;
				vector2 = textElementInfo[i].vertexBottomRight.position;
				vector2.y *= -1f;
				textInfo.meshInfo[materialReferenceIndex].vertexData[3 + vertexCount].position = vector2 + vector;
