		...
		public static bool StartAnimationInline(VisualElement element, StylePropertyId id, ref ComputedStyle computedStyle, StyleValue sv, int durationMs, int delayMs, Func<float, float> easingCurve)
		{
			...
			else
			{
				...
				case StylePropertyId.UnityBackgroundImageTintColor:
				{
					...
					bool flag7 = element.styleAnimation.Start(StylePropertyId.UnityBackgroundImageTintColor, computedStyle.rareData.Read().unityBackgroundImageTintColor, color3, durationMs, delayMs, easingCurve);
				...
				default:
					...
					case StylePropertyId.BackgroundColor:
					{
						...
						bool flag9 = element.styleAnimation.Start(StylePropertyId.BackgroundColor, computedStyle.visualData.Read().backgroundColor, color4, durationMs, delayMs, easingCurve);
					...
					case StylePropertyId.BorderBottomColor:
					{
						...
						bool flag11 = element.styleAnimation.Start(StylePropertyId.BorderBottomColor, computedStyle.visualData.Read().borderBottomColor, color5, durationMs, delayMs, easingCurve);
					...
					case StylePropertyId.BorderLeftColor:
					{
						...
						bool flag13 = element.styleAnimation.Start(StylePropertyId.BorderLeftColor, computedStyle.visualData.Read().borderLeftColor, color6, durationMs, delayMs, easingCurve);
					...
					case StylePropertyId.BorderRightColor:
					{
						...
						bool flag15 = element.styleAnimation.Start(StylePropertyId.BorderRightColor, computedStyle.visualData.Read().borderRightColor, color7, durationMs, delayMs, easingCurve);
					...
					case StylePropertyId.BorderTopColor:
					{
						...
						bool flag17 = element.styleAnimation.Start(StylePropertyId.BorderTopColor, computedStyle.visualData.Read().borderTopColor, color8, durationMs, delayMs, easingCurve);
