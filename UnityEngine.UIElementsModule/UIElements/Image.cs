...
namespace UnityEngine.UIElements
{
	public class Image : VisualElement
	{
		...
		private void OnCustomStyleResolved(CustomStyleResolvedEvent e)
		{
			...
			{
				int num;
				bool flag6 = StyleSheetCache.TryParseEnum<ScaleMode>(text, out num);
				if (flag6)
				{
					this.m_ScaleMode = (ScaleMode)num;
				}
			}
			bool flag7 = !this.m_TintColorIsInline && customStyle.TryGetValue(Image.s_TintColorProperty, out white);
			if (flag7)
			{
