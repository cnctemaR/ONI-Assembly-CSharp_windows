...
namespace UnityEngine.UIElements
{
	...
	internal class VisualElementAsset : IUxmlAttributes, ISerializationCallbackReceiver
	{
		...
		public List<string> stylesheetPaths
		{
			get
			{
				return (this.m_StylesheetPaths == null) ? (this.m_StylesheetPaths = new List<string>()) : this.m_StylesheetPaths;
			}
			set
			{
		...
		public List<StyleSheet> stylesheets
		{
			get
			{
				return (this.m_Stylesheets == null) ? (this.m_Stylesheets = new List<StyleSheet>()) : this.m_Stylesheets;
			}
			set
			{
