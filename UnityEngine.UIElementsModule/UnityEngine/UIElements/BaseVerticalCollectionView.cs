...
namespace UnityEngine.UIElements
{
	public abstract class BaseVerticalCollectionView : BindableElement, ISerializationCallbackReceiver
	{
		...
		internal bool RaiseCanStartDrag(ReusableCollectionItem item, IEnumerable<int> ids, EventModifiers modifiers)
		{
			...
			return func == null || func(new CanStartDragArgs((item != null) ? item.rootElement : null, (item != null) ? item.id : BaseTreeView.invalidId, ids, modifiers));
		}
		...
		internal ReadOnlySpan<int> selectedIndicesSpan
		{
			get
			{
				return NoAllocHelpers.CreateReadOnlySpan<int>(this.m_Selection.indices);
			}
		}
		...
		internal BaseVerticalCollectionView.pointerProcessingStateEnum pointerProcessingState
		{
		...
		public BaseVerticalCollectionView()
		{
			...
			this.m_RangeSelectionDirection = BaseVerticalCollectionView.RangeSelectionDirection.None;
		...
		{
			BaseVerticalCollectionView.<>c__DisplayClass205_0 CS$<>8__locals1;
			...
			if (flag)
			{
				...
				this.<RefreshSelection>g__NotifyIfChanged|205_0(ref CS$<>8__locals1);
			}
			else
			{
		...
		{
			BaseVerticalCollectionView.<>c__DisplayClass216_0 CS$<>8__locals1;
			CS$<>8__locals1.<>4__this = this;
			...
			else
			{
				...
				{
					int num = ((this.m_Selection.indexCount == 0) ? (-1) : ((this.m_RangeSelectionDirection != BaseVerticalCollectionView.RangeSelectionDirection.Down) ? this.m_Selection.minIndex : this.m_Selection.maxIndex)) - 1;
					bool flag3 = num >= 0;
					if (flag3)
					{
						bool flag4 = this.m_RangeSelectionDirection == BaseVerticalCollectionView.RangeSelectionDirection.None;
						if (flag4)
						{
							this.m_RangeSelectionDirection = BaseVerticalCollectionView.RangeSelectionDirection.Up;
						}
						this.<Apply>g__HandleSelectionAndScroll|216_0(num, ref CS$<>8__locals1);
						return true;
					}
					break;
				}
				...
				{
					int num2 = ((this.m_Selection.indexCount == 0) ? (-1) : ((this.m_RangeSelectionDirection != BaseVerticalCollectionView.RangeSelectionDirection.Up) ? this.m_Selection.maxIndex : this.m_Selection.minIndex)) + 1;
					bool flag5 = num2 < this.m_ViewController.itemsSource.Count;
					if (flag5)
					{
						bool flag6 = this.m_RangeSelectionDirection == BaseVerticalCollectionView.RangeSelectionDirection.None;
						if (flag6)
						{
							this.m_RangeSelectionDirection = BaseVerticalCollectionView.RangeSelectionDirection.Down;
						}
						this.<Apply>g__HandleSelectionAndScroll|216_0(num2, ref CS$<>8__locals1);
						return true;
					}
					break;
				}
				...
				case KeyboardNavigationOperation.PageUp:
				{
					...
					if (flag9)
					{
						bool flag10 = this.m_RangeSelectionDirection == BaseVerticalCollectionView.RangeSelectionDirection.None;
						if (flag10)
						{
							this.m_RangeSelectionDirection = BaseVerticalCollectionView.RangeSelectionDirection.Up;
						}
						int num3 = ((this.m_RangeSelectionDirection == BaseVerticalCollectionView.RangeSelectionDirection.Up) ? this.m_Selection.minIndex : this.m_Selection.maxIndex);
						this.<Apply>g__HandleSelectionAndScroll|216_0(Mathf.Max(0, num3 - (this.virtualizationController.visibleItemCount - 1)), ref CS$<>8__locals1);
					}
					return true;
				}
				case KeyboardNavigationOperation.PageDown:
				{
					...
					if (flag11)
					{
						bool flag12 = this.m_RangeSelectionDirection == BaseVerticalCollectionView.RangeSelectionDirection.None;
						if (flag12)
						{
							this.m_RangeSelectionDirection = BaseVerticalCollectionView.RangeSelectionDirection.Down;
						}
						int num4 = ((this.m_RangeSelectionDirection == BaseVerticalCollectionView.RangeSelectionDirection.Up) ? this.m_Selection.minIndex : this.m_Selection.maxIndex);
						this.<Apply>g__HandleSelectionAndScroll|216_0(Mathf.Min(this.viewController.itemsSource.Count - 1, num4 + (this.virtualizationController.visibleItemCount - 1)), ref CS$<>8__locals1);
					}
					return true;
				}
				case KeyboardNavigationOperation.Begin:
					this.<Apply>g__HandleSelectionAndScroll|216_0(0, ref CS$<>8__locals1);
					return true;
				case KeyboardNavigationOperation.End:
					this.<Apply>g__HandleSelectionAndScroll|216_0(this.m_ViewController.itemsSource.Count - 1, ref CS$<>8__locals1);
					return true;
				default:
		...
		{
			this.pointerProcessingState = BaseVerticalCollectionView.pointerProcessingStateEnum.PointerDown;
			try
			{
				bool flag = !this.HasValidDataAndBindings();
				if (!flag)
				{
					...
					if (!flag2)
					{
						...
						if (!flag3)
						{
							this.currentPointerButton = evt.button;
			...
			{
				this.pointerProcessingState = BaseVerticalCollectionView.pointerProcessingStateEnum.None;
				this.currentPointerButton = -1;
			}
		}
		...
		{
			bool flag = rangeSelectionFinalIndex < 0 || rangeSelectionFinalIndex >= this.m_ViewController.itemsSource.Count;
			if (!flag)
			{
				int num = this.m_Selection.minIndex;
				int num2 = this.m_Selection.maxIndex;
				BaseVerticalCollectionView.RangeSelectionDirection rangeSelectionDirection = this.m_RangeSelectionDirection;
				BaseVerticalCollectionView.RangeSelectionDirection rangeSelectionDirection2 = rangeSelectionDirection;
				if (rangeSelectionDirection2 != BaseVerticalCollectionView.RangeSelectionDirection.Up)
				{
					if (rangeSelectionDirection2 != BaseVerticalCollectionView.RangeSelectionDirection.Down)
					{
		...
		internal unsafe void AddToSelection(ReadOnlySpan<int> indexes)
		{
			bool flag = !this.HasValidDataAndBindings() || indexes.Length == 0;
			if (!flag)
			{
		...
		internal unsafe void SetSelectionInternal(IEnumerable<int> indices, bool sendNotification)
		{
			bool flag = indices == null;
			if (!flag)
			{
				int num = indices.Count<int>();
				bool flag2 = num == 0;
				if (flag2)
				{
					this.SetSelectionInternal(default(Span<int>), sendNotification);
				}
				else
				{
					bool flag3 = num < 16;
					if (flag3)
					{
						...
						checked
						{
							Span<int> span = new Span<int>(stackalloc byte[unchecked((UIntPtr)num2) * 4], num2);
							span2 = span;
							num3 = 0;
						}
					...
					else
					{
						...
						try
						{
							...
							int num5 = 0;
							foreach (int num6 in indices)
							{
								*span3[num5++] = num6;
							}
							Span<int> span = span3;
							span3 = span.Slice(0, num5);
		...
		internal unsafe void SetSelectionInternal(ReadOnlySpan<int> indices, bool sendNotification)
		{
			bool flag = !this.HasValidDataAndBindings();
			if (!flag)
			{
				...
				if (!flag2)
				{
					...
					this.ClearSelectionWithoutValidation();
					bool flag3 = this.m_Selection.capacity < indices.Length;
					if (flag3)
					{
		...
		[CompilerGenerated]
		private void <RefreshSelection>g__NotifyIfChanged|205_0(ref BaseVerticalCollectionView.<>c__DisplayClass205_0 A_1)
		{
		...
		[CompilerGenerated]
		private void <Apply>g__HandleSelectionAndScroll|216_0(int index, ref BaseVerticalCollectionView.<>c__DisplayClass216_0 A_2)
		{
		...
		private BaseVerticalCollectionView.RangeSelectionDirection m_RangeSelectionDirection;
		...
		public new abstract class UxmlSerializedData : BindableElement.UxmlSerializedData
		{
			...
			public new static void Register()
			{
				...
				{
					new UxmlAttributeNames("fixedItemHeight", "fixed-item-height", null, new string[] { "itemHeight", "item-height" }),
