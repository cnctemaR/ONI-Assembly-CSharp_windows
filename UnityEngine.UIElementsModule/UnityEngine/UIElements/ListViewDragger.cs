...
namespace UnityEngine.UIElements
{
	internal class ListViewDragger : DragEventsProcessor
	{
		...
		private DragVisualMode GetVisualMode(Vector3 pointerPosition, EventModifiers modifiers, ref ListViewDragger.DragPosition dragPosition)
		{
			bool flag = this.dragAndDropController == null;
		...
		protected DragAndDropArgs MakeDragAndDropArgs(ListViewDragger.DragPosition dragPosition, EventModifiers modifiers)
		{
			object obj = null;
