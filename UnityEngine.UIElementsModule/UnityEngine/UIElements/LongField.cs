	...
	public class LongField : TextValueField<long>
	{
		...
		private class LongInput : TextValueField<long>.TextValueInput
		{
			...
			protected override string allowedCharacters
			{
				get
				{
					return this.parentLongField.supportExpressions ? UINumericFieldsUtils.k_AllowedCharactersForInt : UINumericFieldsUtils.k_AllowedCharactersForInt_NoExpressions;
				}
			}
