	...
	internal static class StyleDebug
	{
		public static object GetComputedStyleValue(in ComputedStyle computedStyle, StylePropertyId id)
		{
			if (id <= StylePropertyId.UnityTextOverflowPosition)
			{
				...
				{
					ComputedStyle computedStyle2 = computedStyle;
					return computedStyle2.unityMaterial;
				}
				...
				default:
					...
					{
						ComputedStyle computedStyle2 = computedStyle;
						return computedStyle2.aspectRatio;
					}
		...
		public static object ConvertComputedToInlineStyleValue(StylePropertyId id, object value)
		{
			if (id <= StylePropertyId.UnityTextOverflowPosition)
			{
				...
				case StylePropertyId.UnityMaterial:
					return (MaterialDefinition)value;
				case StylePropertyId.UnityParagraphSpacing:
					return (Length)value;
				case StylePropertyId.UnityTextAlign:
				...
				default:
					...
					default:
						...
						case StylePropertyId.BorderTopRightRadius:
							return (Length)value;
						case StylePropertyId.Filter:
							return (List<FilterFunction>)value;
						case StylePropertyId.Opacity:
							return (float)value;
						case StylePropertyId.Overflow:
		...
		public static bool IsDiscreteTypeProperty(StylePropertyId id)
		{
			...
			{
				if (id <= StylePropertyId.WhiteSpace)
				{
					switch (id)
					{
					case StylePropertyId.UnityFont:
					...
					case StylePropertyId.UnityTextAlign:
						return true;
					default:
						if (id == StylePropertyId.Visibility)
						{
							return true;
						}
						if (id == StylePropertyId.WhiteSpace)
				...
				else if (id <= StylePropertyId.Display)
				{
					switch (id)
					{
					case StylePropertyId.AlignContent:
