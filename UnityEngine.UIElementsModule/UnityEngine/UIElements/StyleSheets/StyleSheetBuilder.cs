...
namespace UnityEngine.UIElements.StyleSheets
{
	internal class StyleSheetBuilder
	{
		...
		public StyleRule BeginRule(int ruleLine)
		{
			...
			this.m_CurrentRule = new StyleRule(null)
			{
				line = ruleLine
			};
		...
		public int EndRule()
		{
			...
			this.m_CurrentRule.SetSelectors(this.m_ComplexSelectors.ToArray());
			this.m_ComplexSelectors.Clear();
			this.m_CurrentRule.SetProperties(this.m_CurrentProperties.ToArray());
		...
		public void BuildTo(StyleSheet writeTo)
		{
			...
			writeTo.SetRules(this.m_Rules.ToArray());
