			...
			while (i < syntax.Length)
			{
				...
				if (c3 <= '[')
				{
					...
					case ',':
						...
						break;
					case '/':
						this.m_Tokens.Add(new StyleSyntaxToken(StyleSyntaxTokenType.String, syntax.Substring(i, 1)));
						break;
					default:
						switch (c3)
						{
				...
				else if (c3 != ']')
				{
					...
					default:
						...
						this.m_Tokens.Add(new StyleSyntaxToken(StyleSyntaxTokenType.Number, float.PositiveInfinity));
						break;
					}
				}
				else
				...
				if (flag3)
				{
					...
					this.m_Tokens.Add(new StyleSyntaxToken(StyleSyntaxTokenType.Number, (float)num3));
				}
				else
				{
