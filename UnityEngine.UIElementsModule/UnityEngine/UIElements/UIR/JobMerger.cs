...
namespace UnityEngine.UIElements.UIR
{
	internal class JobMerger : IDisposable
	{
		public JobMerger(int capacity)
		{
			...
			this.m_Jobs = new NativeArray<JobHandle>(capacity, JobMerger.k_MemoryLabel, NativeArrayOptions.UninitializedMemory);
		}
		...
		private static readonly MemoryLabel k_MemoryLabel = new MemoryLabel("UIElements", "Renderer.JobMerger", Allocator.Persistent);
