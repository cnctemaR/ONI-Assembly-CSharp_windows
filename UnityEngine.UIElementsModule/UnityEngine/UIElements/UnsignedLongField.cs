	...
	public class UnsignedLongField : TextValueField<ulong>
	{
		...
		private class UnsignedLongInput : TextValueField<ulong>.TextValueInput
		{
			...
			protected override string allowedCharacters
			{
				get
				{
					return this.parentUnsignedLongField.supportExpressions ? UINumericFieldsUtils.k_AllowedCharactersForInt : UINumericFieldsUtils.k_AllowedCharactersForUInt_NoExpressions;
				}
			}
