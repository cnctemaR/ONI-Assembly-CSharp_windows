...
namespace UnityEngine.UIElements
{
	internal class VisualTreeBindingsUpdater : BaseVisualTreeHierarchyTrackerUpdater
	{
		...
		{
			return VisualTreeBindingsUpdater.disableBindingsThrottling || this.CurrentTime() - startTime < 100L;
		}
		...
		public override void Update()
		{
			...
			if (flag)
			{
				...
				{
					long num = this.CurrentTime();
					while (this.m_ElementsToBind.Count > 0 && this.ShouldProcessBindings(num))
					{
