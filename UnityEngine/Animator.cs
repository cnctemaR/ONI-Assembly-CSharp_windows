...
namespace UnityEngine
{
	...
	public sealed class Animator : Behaviour
	{
		...
		{
			Vector3 vector;
			Animator.INTERNAL_CALL_GetBodyPositionInternal(this, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Animator.INTERNAL_CALL_GetIKPositionInternal(this, goal, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Animator.INTERNAL_CALL_GetIKHintPositionInternal(this, hint, out vector);
			return vector;
		}
