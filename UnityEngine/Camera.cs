...
namespace UnityEngine
{
	...
	public sealed class Camera : Behaviour
	{
		...
		public Matrix4x4 nonJitteredProjectionMatrix
		{
			...
			{
				Matrix4x4 matrix4x;
				this.INTERNAL_get_nonJitteredProjectionMatrix(out matrix4x);
				return matrix4x;
			}
			set
			{
		...
		{
			Matrix4x4 matrix4x;
			Camera.INTERNAL_CALL_GetStereoViewMatrix(this, eye, out matrix4x);
			return matrix4x;
		}
		...
		{
			Matrix4x4 matrix4x;
			Camera.INTERNAL_CALL_GetStereoProjectionMatrix(this, eye, out matrix4x);
			return matrix4x;
		}
		...
		{
			Vector3 vector;
			Camera.INTERNAL_CALL_WorldToScreenPoint(this, ref position, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Camera.INTERNAL_CALL_WorldToViewportPoint(this, ref position, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Camera.INTERNAL_CALL_ViewportToWorldPoint(this, ref position, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Camera.INTERNAL_CALL_ScreenToWorldPoint(this, ref position, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Camera.INTERNAL_CALL_ScreenToViewportPoint(this, ref position, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Camera.INTERNAL_CALL_ViewportToScreenPoint(this, ref position, out vector);
			return vector;
		}
		...
		public Matrix4x4 cullingMatrix
		{
			...
			{
				Matrix4x4 matrix4x;
				this.INTERNAL_get_cullingMatrix(out matrix4x);
				return matrix4x;
			}
			set
			{
		...
		{
			Matrix4x4 matrix4x;
			Camera.INTERNAL_CALL_CalculateObliqueMatrix(this, ref clipPlane, out matrix4x);
			return matrix4x;
		}
