...
namespace UnityEngine
{
	...
	public class Collider2D : Behaviour
	{
		...
		public int Raycast(Vector2 direction, RaycastHit2D[] results, float distance)
		{
			...
			float negativeInfinity = float.NegativeInfinity;
			int num = -1;
			return this.Raycast(direction, results, distance, num, negativeInfinity, positiveInfinity);
		}
		...
		public int Raycast(Vector2 direction, RaycastHit2D[] results)
		{
			...
			return this.Raycast(direction, results, positiveInfinity2, num, negativeInfinity, positiveInfinity);
		}
		...
		public int Raycast(Vector2 direction, RaycastHit2D[] results, [DefaultValue("Mathf.Infinity")] float distance, [DefaultValue("Physics2D.AllLayers")] int layerMask, [DefaultValue("-Mathf.Infinity")] float minDepth, [DefaultValue("Mathf.Infinity")] float maxDepth)
		{
			...
			return this.Internal_Raycast(direction, distance, contactFilter2D, results);
		}
		...
		{
			bool flag = true;
			return this.Cast(direction, contactFilter, results, distance, flag);
		}
		...
		public int Cast(Vector2 direction, ContactFilter2D contactFilter, RaycastHit2D[] results)
		{
			bool flag = true;
			float positiveInfinity = float.PositiveInfinity;
			return this.Cast(direction, contactFilter, results, positiveInfinity, flag);
		}
		...
		{
			bool flag = true;
			return this.Cast(direction, results, distance, flag);
		}
		...
		public int Cast(Vector2 direction, RaycastHit2D[] results)
		{
			bool flag = true;
			float positiveInfinity = float.PositiveInfinity;
			return this.Cast(direction, results, positiveInfinity, flag);
		}
		...
		public int Cast(Vector2 direction, RaycastHit2D[] results, [DefaultValue("Mathf.Infinity")] float distance, [DefaultValue("true")] bool ignoreSiblingColliders)
		{
			...
			return this.Internal_Cast(direction, contactFilter2D, distance, ignoreSiblingColliders, results);
		}
