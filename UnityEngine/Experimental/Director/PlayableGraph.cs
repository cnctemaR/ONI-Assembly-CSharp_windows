...
namespace UnityEngine.Experimental.Director
{
	...
	public struct PlayableGraph
	{
		...
		public static PlayableGraph CreateGraph()
		{
			...
			PlayableGraph.InternalCreate(ref playableGraph);
		...
		public ScriptPlayableOutput CreateScriptOutput(string name)
		{
			...
			ScriptPlayableOutput scriptPlayableOutput2;
			if (!PlayableGraph.InternalCreateScriptOutput(ref this, name, out scriptPlayableOutput.m_Output))
			{
				scriptPlayableOutput2 = ScriptPlayableOutput.Null;
			}
			else
			{
				scriptPlayableOutput2 = scriptPlayableOutput;
			}
			return scriptPlayableOutput2;
		}
		...
		{
			int num = 0;
			return this.CreateGenericMixerPlayable(num);
		}
