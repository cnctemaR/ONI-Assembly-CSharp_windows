	...
	public struct PlayableHandle
	{
		public T GetObject<T>() where T : Playable
		{
			...
			else
			{
				...
				else
				{
					...
					T t2 = (T)((object)Activator.CreateInstance(playableTypeOf));
					t2.handle = this;
					PlayableHandle.SetScriptInstance(ref this, t2);
					t = t2;
				}
			}
			return t;
		...
		internal bool CheckInputBounds(int inputIndex, bool acceptAny)
		{
			...
			else
			{
				...
				{
					throw new IndexOutOfRangeException(string.Concat(new object[] { "inputIndex ", inputIndex, " is greater than the number of available inputs (", this.inputCount, ")." }));
				}
				flag = true;
			}
			return flag;
