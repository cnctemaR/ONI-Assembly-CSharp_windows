...
namespace UnityEngine.Rendering
{
	...
	public sealed class CommandBuffer : IDisposable
	{
		...
		{
			bool flag = false;
			this.GetTemporaryRT(nameID, width, height, depthBuffer, filter, format, readWrite, antiAliasing, flag);
		}
		...
		public void GetTemporaryRT(int nameID, int width, int height, int depthBuffer, FilterMode filter, RenderTextureFormat format, RenderTextureReadWrite readWrite)
		{
			bool flag = false;
			int num = 1;
			this.GetTemporaryRT(nameID, width, height, depthBuffer, filter, format, readWrite, num, flag);
		}
		...
		public void GetTemporaryRT(int nameID, int width, int height, int depthBuffer, FilterMode filter, RenderTextureFormat format)
		{
			...
			this.GetTemporaryRT(nameID, width, height, depthBuffer, filter, format, renderTextureReadWrite, num, flag);
		}
		...
		public void GetTemporaryRT(int nameID, int width, int height, int depthBuffer, FilterMode filter)
		{
			...
			this.GetTemporaryRT(nameID, width, height, depthBuffer, filter, renderTextureFormat, renderTextureReadWrite, num, flag);
		}
		...
		public void GetTemporaryRT(int nameID, int width, int height, int depthBuffer)
		{
			...
			this.GetTemporaryRT(nameID, width, height, depthBuffer, filterMode, renderTextureFormat, renderTextureReadWrite, num, flag);
		}
		...
		public void GetTemporaryRT(int nameID, int width, int height)
		{
			...
			FilterMode filterMode = FilterMode.Point;
			int num2 = 0;
			this.GetTemporaryRT(nameID, width, height, num2, filterMode, renderTextureFormat, renderTextureReadWrite, num, flag);
		}
