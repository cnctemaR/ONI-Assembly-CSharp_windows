...
namespace UnityEngine
{
	...
	public struct Vector3
	{
		...
		{
			Vector3 vector;
			Vector3.INTERNAL_CALL_Slerp(ref a, ref b, t, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Vector3.INTERNAL_CALL_SlerpUnclamped(ref a, ref b, t, out vector);
			return vector;
		}
		...
		{
			Vector3 vector;
			Vector3.INTERNAL_CALL_RotateTowards(ref current, ref target, maxRadiansDelta, maxMagnitudeDelta, out vector);
			return vector;
		}
		...
		public override bool Equals(object other)
		{
			...
			else
			{
				...
				flag = this.x.Equals(vector.x) && this.y.Equals(vector.y) && this.z.Equals(vector.z);
			}
			return flag;
		}
