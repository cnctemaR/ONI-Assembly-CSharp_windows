...
namespace VYaml.Serialization
{
	[NullableContext(1)]
	[Nullable(0)]
	public class InterfaceDictionaryFormatter<TKey, [Nullable(2)] TValue> : IYamlFormatter<IDictionary<TKey, TValue>>, IYamlFormatter
	{
		public void Serialize(ref Utf8YamlEmitter emitter, [Nullable(new byte[] { 2, 1, 1 })] IDictionary<TKey, TValue> value, YamlSerializationContext context)
		{
			if (value == null)
			{
				emitter.WriteNull();
