...
namespace VYaml.Serialization
{
	...
	{
		[NullableContext(1)]
		public void Serialize(ref Utf8YamlEmitter emitter, [Nullable(new byte[] { 2, 1, 1, 1 })] Tuple<T1, T2, T3> value, YamlSerializationContext context)
		{
			if (value == null)
			{
				emitter.WriteNull();
		...
		public Tuple<T1, T2, T3> Deserialize(ref YamlParser parser, YamlDeserializationContext context)
		{
			...
			return new Tuple<T1, T2, T3>(t, t2, t3);
		}
	}
}
