...
namespace VYaml.Serialization
{
	...
	{
		[NullableContext(1)]
		public void Serialize(ref Utf8YamlEmitter emitter, [Nullable(new byte[] { 2, 1, 1, 1, 1, 1, 1, 1, 1 })] Tuple<T1, T2, T3, T4, T5, T6, T7, T8> value, YamlSerializationContext context)
		{
			if (value == null)
			{
				emitter.WriteNull();
		...
		[NullableContext(1)]
		[return: Nullable(new byte[] { 2, 1, 1, 1, 1, 1, 1, 1, 1 })]
		public Tuple<T1, T2, T3, T4, T5, T6, T7, T8> Deserialize(ref YamlParser parser, YamlDeserializationContext context)
		{
			...
			T8 t8 = context.DeserializeWithAlias<T8>(ref parser);
			parser.ReadWithVerify(ParseEventType.SequenceEnd);
			return new Tuple<T1, T2, T3, T4, T5, T6, T7, T8>(t, t2, t3, t4, t5, t6, t7, t8);
		}
	}
}
