...
namespace VYaml.Serialization
{
	...
	{
		[NullableContext(1)]
		public void Serialize(ref Utf8YamlEmitter emitter, [Nullable(new byte[] { 0, 1, 1, 1, 1 })] ValueTuple<T1, T2, T3, T4> value, YamlSerializationContext context)
		{
		...
		public ValueTuple<T1, T2, T3, T4> Deserialize(ref YamlParser parser, YamlDeserializationContext context)
		{
			...
			return new ValueTuple<T1, T2, T3, T4>(t, t2, t3, t4);
		}
	}
}
