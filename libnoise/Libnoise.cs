...
namespace LibNoiseDotNet.Graphics.Tools.Noise
{
	public static class Libnoise
	{
		...
		{
			float num = (float)Math.Cos((double)(0.017453292f * lat));
			x = num * (float)Math.Cos((double)(0.017453292f * lon));
			y = (float)Math.Sin((double)(0.017453292f * lat));
			z = num * (float)Math.Sin((double)(0.017453292f * lon));
		}

		public static byte Lerp(byte n0, byte n1, float a)
		{
			float num = (float)n0 / 255f;
			float num2 = (float)n1 / 255f;
		...
		{
			return Libnoise.Clamp(value, 0, 1);
		}

		public static float Clamp01(float value)
		{
			return Libnoise.Clamp(value, 0f, 1f);
		}

		public static double Clamp01(double value)
		{
			return Libnoise.Clamp(value, 0.0, 1.0);
		}
		...
		public static byte[] UnpackLittleUint32(int value, ref byte[] buffer)
		{
			...
			buffer[3] = (byte)(((long)value & (long)((ulong)(-16777216))) >> 24);
			return buffer;
		}
		...
		public const float SQRT_2 = 1.4142135f;
